...
public:
    ...
    */
     ...
     */
    struct PsdMapData * IsCurIdInList();
    ...
    /**
     * @brief get mLastSegmentId
     * @return uint8_t 
     */
    uint8_t getmLastSegmentId();

    /**
     * @brief set lastSegmentId
     * @param lastSegmentId 
     */
    void setmLastSegmentId(uint8_t lastSegmentId);
    ...
    /**
     * @brief get HV position from Ego Vehicle Data Handler (assump function, actually belongs to HvMsg class)
     * @return Position3D_D 
     */
    Position3D_D getHVPosition();

    /**
     * @brief get HV heading from Ego Vehicle Data Handler (assump function, actually belongs to HvMsg class)
     * @param heading 
    ...
    /**
     * @brief  get HV's heading whether has changed from Ego Vehicle Data Handler (assump function, actually belongs to HvMsg class)
...
private:
    ...
    bool mDoInsert;                                                     /** <   indicates whether an action has been inserted in the traversal  */ 

    uint8_t mCount;                                                     /** <  indicates number of inserted elements in the database  */  

    uint8_t mLastSegmentId;                                  /** <  record the last segment id of HV drived  */  
