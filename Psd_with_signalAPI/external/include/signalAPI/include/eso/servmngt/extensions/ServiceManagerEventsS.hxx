...
*/
#ifndef SERVMNGT_EXTENSIONS_SERVICEMANAGEREVENTSS_HXX
#define SERVMNGT_EXTENSIONS_SERVICEMANAGEREVENTSS_HXX
...
#include <servmngt/extensions/ServiceManagerEventsServiceRegistration.hxx>
#include <servmngt/extensions/StructWatchdogMissedEvent.hxx>

#include <servmngt/extensions/Definitions.hxx>

#include <servmngt/extensions/ServiceManagerEventsProxyReply.hxx>
...
namespace extensions
{
    ...
    /**
    \brief  The extensions::ServiceManagerEvents interface on tthe service side.
    \details
    ...
    // List of request methods
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            ServiceManagerEventsServiceRegistration tmp{m_registration};
...
#endif// SERVMNGT_EXTENSIONS_SERVICEMANAGEREVENTSS_HXX
