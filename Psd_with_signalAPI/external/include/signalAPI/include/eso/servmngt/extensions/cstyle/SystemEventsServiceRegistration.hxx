...
*/
#ifndef SERVMNGT_EXTENSIONS_SYSTEMEVENTS_SERVICEREGISTRATION_CSTYLE_HXX
#define SERVMNGT_EXTENSIONS_SYSTEMEVENTS_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the extensions::SystemEvents interface.
    */
    class SystemEventsServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        SystemEventsServiceRegistration (const ::comm::InstanceID& _instID, SystemEventsS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        SystemEventsServiceRegistration (const ::comm::InstanceID& _instID, SystemEventsS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        SystemEventsServiceRegistration (const ::comm::InstanceID& _instID, SystemEventsS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        SystemEventsServiceRegistration (const ::comm::InstanceID& _instID, SystemEventsS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        SystemEventsServiceRegistration() {}
...
#endif// SERVMNGT_EXTENSIONS_SYSTEMEVENTS_SERVICEREGISTRATION_HXX
