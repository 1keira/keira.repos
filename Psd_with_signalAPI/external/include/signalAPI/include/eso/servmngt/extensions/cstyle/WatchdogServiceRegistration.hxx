...
*/
#ifndef SERVMNGT_EXTENSIONS_WATCHDOG_SERVICEREGISTRATION_CSTYLE_HXX
#define SERVMNGT_EXTENSIONS_WATCHDOG_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the extensions::Watchdog interface.
    */
    class WatchdogServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        WatchdogServiceRegistration (const ::comm::InstanceID& _instID, WatchdogS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        WatchdogServiceRegistration (const ::comm::InstanceID& _instID, WatchdogS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        WatchdogServiceRegistration (const ::comm::InstanceID& _instID, WatchdogS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        WatchdogServiceRegistration (const ::comm::InstanceID& _instID, WatchdogS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
...
#endif// SERVMNGT_EXTENSIONS_WATCHDOG_SERVICEREGISTRATION_HXX
