...
*/
#ifndef SERVMNGT_EXTENSIONS_WATCHDOGS_HXX
#define SERVMNGT_EXTENSIONS_WATCHDOGS_HXX
...
#include <servmngt/extensions/WatchdogServiceRegistration.hxx>

#include <servmngt/extensions/Definitions.hxx>

#include <servmngt/extensions/WatchdogProxyReply.hxx>
...
namespace extensions
{
    ...
    /**
    \brief  The extensions::Watchdog interface on tthe service side.
    \details
    ...
    // List of request methods
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            WatchdogServiceRegistration tmp{m_registration};
...
#endif// SERVMNGT_EXTENSIONS_WATCHDOGS_HXX
