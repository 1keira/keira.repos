...
{ 
    ...
    OptionalUnlabeledTracker::check(true, UnlabeledMultiArg<T>::toString());
}
...
template<class T>
bool UnlabeledMultiArg<T>::processArg(int *i, std::vector<std::string>& args) IPL_NOEXCEPT 
{
...
template<class T>
std::string UnlabeledMultiArg<T>::shortID(const std::string& val) const IPL_NOEXCEPT
{
...
template<class T>
std::string UnlabeledMultiArg<T>::longID(const std::string& val) const IPL_NOEXCEPT
{
    static_cast<void>(val); // Ignore input, don't warn
...
template<class T>
bool UnlabeledMultiArg<T>::operator==(const Arg& a) const IPL_NOEXCEPT
{
...
template<class T>
void UnlabeledMultiArg<T>::addToList( std::list<Arg*>& argList ) const IPL_NOEXCEPT
{
