...
*/
#ifndef ASI_SID_LHWAPP_ESC50STRUCT_CSTYLE_HXX
#define ASI_SID_LHWAPP_ESC50STRUCT_CSTYLE_HXX
...
bool serialize (util::serializer::IStructuredSerializer &ser, const asi::sid::lhwapp::cstyle::ESC50Struct& val);
bool deserialize (util::serializer::IStructuredPullDeserializer &s, asi::sid::lhwapp::cstyle::ESC50Struct &val);
}
}
...
namespace  cstyle
{
    ...
    */
    struct PROXY_EXPORT ESC50Struct
    {
        ...
        uint64_t m_PduState;
    private:
        friend bool util::serializer::serialize (util::serializer::IStructuredSerializer &s, const asi::sid::lhwapp::cstyle::ESC50Struct& val);
        friend bool util::serializer::deserialize (util::serializer::IStructuredPullDeserializer &s, asi::sid::lhwapp::cstyle::ESC50Struct &val);
    };
...
#endif// ASI_SID_LHWAPP_ESC50STRUCT_CSTYLE_HXX
