...
*/
#ifndef ASI_VEHICLE_TEST_REPLYS_CSTYLE_HXX
#define ASI_VEHICLE_TEST_REPLYS_CSTYLE_HXX
    ...
    **/
    ...
    public:
        ...
        virtual bool updateKlemmen_Status_01 (
            const asi::vehicle::cstyle::KlemmenStatus01Struct* Klemmen_Status_01,
            const bool isValid
        ) = 0;
...
#endif// ASI_VEHICLE_TEST_REPLYS_CSTYLE_HXX
