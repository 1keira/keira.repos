...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTS_SERVICEREPLYREGISTRATION_CSTYLE_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTS_SERVICEREPLYREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticVoiceMeasurementsReply interface.
    */
    class DiagnosticVoiceMeasurementsServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticVoiceMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticVoiceMeasurementsReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticVoiceMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticVoiceMeasurementsReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.DiagnosticVoiceMeasurementsReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
