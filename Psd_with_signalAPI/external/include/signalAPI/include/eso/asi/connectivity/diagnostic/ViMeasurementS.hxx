...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENTS_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENTS_HXX
...
#include <asi/connectivity/diagnostic/ViMeasurementServiceRegistration.hxx>

#include <asi/connectivity/diagnostic/Definitions.hxx>

#include <asi/connectivity/diagnostic/ViMeasurementProxyReply.hxx>
...
namespace diagnostic
{
    ...
    /**
    \brief  The diagnostic::ViMeasurement interface on tthe service side.
    \details
            A service instance needs to implement this interface.
    **/
    class ViMeasurementS
    {
    public:
        ViMeasurementS () {}
    // List of request methods
        ...
        */
        bool registerSelf(uint32_t instance_no, const comm::ActiveObjectFactoryPtr& factory, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                ViMeasurementServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_REQUEST), instance_no), static_cast<ViMeasurementS*>(this), l, factory );
        ...
        */
        bool registerSelf(uint32_t instance_no, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                ViMeasurementServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_REQUEST), instance_no), static_cast<ViMeasurementS*>(this), l );
            if (!m_registration.valid()) {
                comm::error::fatal( "can't create ServiceRegistration, OOM ", COMM_HERE);
                return true;
            }
        ...
        */
        bool unregisterSelf()
        {
            ...
            m_registration = ViMeasurementServiceRegistration();
            return false;
        }
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            ViMeasurementServiceRegistration tmp{m_registration};
        ...
        // call ids
        void
        getMeasurementValues_U32_aU8CallID(comm::CallEvent::CallID& ce)
        {
            void* inst=static_cast<ViMeasurementS*>(this);
    ...
    protected:
        ViMeasurementServiceRegistration m_registration;
    };

} //namespace asi
} //namespace connectivity
} //namespace diagnostic
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENTS_HXX
