...
*/
#ifndef ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICESS_HXX
#define ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICESS_HXX
...
#include <asi/connectivity/al/NadMessagingServicesServiceRegistration.hxx>
#include <asi/connectivity/al/StructTimestamp.hxx>

#include <asi/connectivity/al/Definitions.hxx>

#include <asi/connectivity/al/NadMessagingServicesProxyReply.hxx>
...
namespace al
{
    ...
    /**
    \brief  The al::NadMessagingServices interface on tthe service side.
    \details
    ...
    // List of request methods
        ...
        */
        bool registerSelf(uint32_t instance_no, const comm::ActiveObjectFactoryPtr& factory, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                NadMessagingServicesServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_REQUEST), instance_no), static_cast<NadMessagingServicesS*>(this), l, factory );
        ...
        */
        bool registerSelf(uint32_t instance_no, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                NadMessagingServicesServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_REQUEST), instance_no), static_cast<NadMessagingServicesS*>(this), l );
            if (!m_registration.valid()) {
                comm::error::fatal( "can't create ServiceRegistration, OOM ", COMM_HERE);
                return true;
            }
        ...
        */
        ...
        // call ids
        void
        sendMessageCallID( comm::CallEvent::CallID& ce )
        {
...
#endif// ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICESS_HXX
