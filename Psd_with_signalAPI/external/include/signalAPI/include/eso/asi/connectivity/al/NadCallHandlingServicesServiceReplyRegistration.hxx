...
*/
#ifndef ASI_CONNECTIVITY_AL_NADCALLHANDLINGSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADCALLHANDLINGSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadCallHandlingServicesReply interface.
    */
    class NadCallHandlingServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadCallHandlingServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadCallHandlingServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadCallHandlingServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadCallHandlingServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.NadCallHandlingServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_NADCALLHANDLINGSERVICES_SERVICEREPLYREGISTRATION_HXX
