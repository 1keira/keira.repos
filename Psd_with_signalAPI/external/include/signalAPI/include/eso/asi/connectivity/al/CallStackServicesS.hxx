...
*/
#ifndef ASI_CONNECTIVITY_AL_CALLSTACKSERVICESS_HXX
#define ASI_CONNECTIVITY_AL_CALLSTACKSERVICESS_HXX
...
#include <asi/connectivity/al/CallStackServicesServiceRegistration.hxx>
#include <asi/connectivity/al/StructCallStackEntry.hxx>

#include <asi/connectivity/al/Definitions.hxx>

#include <asi/connectivity/al/CallStackServicesProxyReply.hxx>
#include <asi/connectivity/al/CallStackServicesReplyS.hxx>
...
namespace al
{
    ...
    /**
    \brief  The al::CallStackServices interface on tthe service side.
    \details
            A service instance needs to implement this interface.
    **/
    class CallStackServicesS
    {
    public:
        CallStackServicesS () {}
    // List of request methods
        ...
        */
        bool registerSelf(uint32_t instance_no, const comm::ActiveObjectFactoryPtr& factory, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                CallStackServicesServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_REQUEST), instance_no), static_cast<CallStackServicesS*>(this), l, factory );
        ...
        */
        bool registerSelf(uint32_t instance_no, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                CallStackServicesServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_REQUEST), instance_no), static_cast<CallStackServicesS*>(this), l );
            if (!m_registration.valid()) {
                comm::error::fatal( "can't create ServiceRegistration, OOM ", COMM_HERE);
                return true;
            }
        ...
        */
        bool unregisterSelf()
        {
            ...
            m_registration = CallStackServicesServiceRegistration();
            return false;
        }
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            CallStackServicesServiceRegistration tmp{m_registration};
        ...
        // call ids
        void
        startCallStackDownloadCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<CallStackServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
            comm::OpaqueMethodID mid= 1;
            ce.assign(inst, mid);
        }
        void
        resetMissedCallCounterCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<CallStackServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
    ...
    protected:
        CallStackServicesServiceRegistration m_registration;
    };

} //namespace asi
} //namespace connectivity
} //namespace al
#endif// ASI_CONNECTIVITY_AL_CALLSTACKSERVICESS_HXX
