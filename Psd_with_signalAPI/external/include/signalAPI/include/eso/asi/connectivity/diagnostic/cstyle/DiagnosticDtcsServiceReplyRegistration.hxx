...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDTCS_SERVICEREPLYREGISTRATION_CSTYLE_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDTCS_SERVICEREPLYREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticDtcsReply interface.
    */
    class DiagnosticDtcsServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticDtcsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticDtcsReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticDtcsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticDtcsReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.DiagnosticDtcsReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDTCS_SERVICEREPLYREGISTRATION_HXX
