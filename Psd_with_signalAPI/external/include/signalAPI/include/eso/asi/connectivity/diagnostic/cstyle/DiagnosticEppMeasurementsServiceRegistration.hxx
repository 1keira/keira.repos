...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICEPPMEASUREMENTS_SERVICEREGISTRATION_CSTYLE_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICEPPMEASUREMENTS_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticEppMeasurements interface.
    */
    class DiagnosticEppMeasurementsServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticEppMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticEppMeasurementsS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticEppMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticEppMeasurementsS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        DiagnosticEppMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticEppMeasurementsS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        DiagnosticEppMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticEppMeasurementsS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        DiagnosticEppMeasurementsServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICEPPMEASUREMENTS_SERVICEREGISTRATION_HXX
