...
*/
#ifndef ASI_CONNECTIVITY_AL_NADINFORMATIONSERVICE_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADINFORMATIONSERVICE_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadInformationService interface.
    */
    class NadInformationServiceServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadInformationServiceServiceRegistration (const ::comm::InstanceID& _instID, NadInformationServiceS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadInformationServiceServiceRegistration (const ::comm::InstanceID& _instID, NadInformationServiceS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        NadInformationServiceServiceRegistration (const ::comm::InstanceID& _instID, NadInformationServiceS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        NadInformationServiceServiceRegistration (const ::comm::InstanceID& _instID, NadInformationServiceS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        NadInformationServiceServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_NADINFORMATIONSERVICE_SERVICEREGISTRATION_HXX
