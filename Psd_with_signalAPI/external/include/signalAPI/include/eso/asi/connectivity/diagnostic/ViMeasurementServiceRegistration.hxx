...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_SERVICEREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::ViMeasurement interface.
    */
    class ViMeasurementServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViMeasurementServiceRegistration (const ::comm::InstanceID& _instID, ViMeasurementS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViMeasurementServiceRegistration (const ::comm::InstanceID& _instID, ViMeasurementS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ViMeasurementServiceRegistration (const ::comm::InstanceID& _instID, ViMeasurementS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        ViMeasurementServiceRegistration (const ::comm::InstanceID& _instID, ViMeasurementS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        ViMeasurementServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_SERVICEREGISTRATION_HXX
