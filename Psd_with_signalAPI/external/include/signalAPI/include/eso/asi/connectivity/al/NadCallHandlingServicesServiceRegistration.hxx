...
*/
#ifndef ASI_CONNECTIVITY_AL_NADCALLHANDLINGSERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADCALLHANDLINGSERVICES_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadCallHandlingServices interface.
    */
    class NadCallHandlingServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadCallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadCallHandlingServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadCallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadCallHandlingServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        NadCallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadCallHandlingServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        NadCallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadCallHandlingServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        NadCallHandlingServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_NADCALLHANDLINGSERVICES_SERVICEREGISTRATION_HXX
