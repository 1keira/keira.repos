...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETSVTTS_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETSVTTS_HXX
...
#include <asi/connectivity/diagnostic/DiagnosticDatasetsVttServiceRegistration.hxx>
#include <asi/connectivity/diagnostic/StructDatasetParameter.hxx>

#include <asi/connectivity/diagnostic/Definitions.hxx>

#include <asi/connectivity/diagnostic/DiagnosticDatasetsVttProxyReply.hxx>
#include <asi/connectivity/diagnostic/DiagnosticDatasetsVttReplyS.hxx>
...
namespace diagnostic
{
    ...
    /**
    \brief  The diagnostic::DiagnosticDatasetsVtt interface on tthe service side.
    \details
    ...
    **/
    ...
    // List of request methods
        ...
        */
        virtual void clientConnected(uint32_t count
            ,DiagnosticDatasetsVttProxyReply& reply
        ) {}
        ...
        */
        bool registerSelf(uint32_t instance_no, const comm::ActiveObjectFactoryPtr& factory, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                DiagnosticDatasetsVttServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETSVTT_REQUEST), instance_no), static_cast<DiagnosticDatasetsVttS*>(this), l, factory );
        ...
        */
        bool registerSelf(uint32_t instance_no, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                DiagnosticDatasetsVttServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETSVTT_REQUEST), instance_no), static_cast<DiagnosticDatasetsVttS*>(this), l );
            if (!m_registration.valid()) {
                comm::error::fatal( "can't create ServiceRegistration, OOM ", COMM_HERE);
                return true;
            }
        ...
        */
        bool unregisterSelf()
        {
            ...
            m_registration = DiagnosticDatasetsVttServiceRegistration();
            return false;
        }
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            DiagnosticDatasetsVttServiceRegistration tmp{m_registration};
        ...
        virtual ~DiagnosticDatasetsVttS()
        {
    ...
    protected:
        DiagnosticDatasetsVttServiceRegistration m_registration;
    };

} //namespace asi
} //namespace connectivity
} //namespace diagnostic
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETSVTTS_HXX
