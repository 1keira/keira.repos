...
*/
#ifndef ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace messaging
{
    ...
    /**
        \brief The service registration instance for the messaging::NadMessagingServicesReply interface.
    */
    class NadMessagingServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadMessagingServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadMessagingServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadMessagingServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadMessagingServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.messaging.NadMessagingServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_SERVICEREPLYREGISTRATION_HXX
