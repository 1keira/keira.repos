...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICCCMMEASUREMENTS_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICCCMMEASUREMENTS_SERVICEREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticCcmMeasurements interface.
    */
    class DiagnosticCcmMeasurementsServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticCcmMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticCcmMeasurementsS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticCcmMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticCcmMeasurementsS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        DiagnosticCcmMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticCcmMeasurementsS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        DiagnosticCcmMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticCcmMeasurementsS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        DiagnosticCcmMeasurementsServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICCCMMEASUREMENTS_SERVICEREGISTRATION_HXX
