...
*/
#ifndef ASI_CONNECTIVITY_AL_NADAUDIOSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADAUDIOSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadAudioServicesReply interface.
    */
    class NadAudioServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadAudioServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadAudioServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadAudioServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadAudioServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.NadAudioServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_NADAUDIOSERVICES_SERVICEREPLYREGISTRATION_HXX
