...
*/
#ifndef ASI_CONNECTIVITY_AL_CALLHANDLINGSERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_CALLHANDLINGSERVICES_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::CallHandlingServices interface.
    */
    class CallHandlingServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        CallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, CallHandlingServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        CallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, CallHandlingServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        CallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, CallHandlingServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        CallHandlingServicesServiceRegistration (const ::comm::InstanceID& _instID, CallHandlingServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        CallHandlingServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_CALLHANDLINGSERVICES_SERVICEREGISTRATION_HXX
