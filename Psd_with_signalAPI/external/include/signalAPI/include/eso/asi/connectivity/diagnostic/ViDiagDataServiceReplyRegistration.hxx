...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIDIAGDATA_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIDIAGDATA_SERVICEREPLYREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::ViDiagDataReply interface.
    */
    class ViDiagDataServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViDiagDataServiceReplyRegistration (const ::comm::InstanceID& _instID, ViDiagDataReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViDiagDataServiceReplyRegistration (const ::comm::InstanceID& _instID, ViDiagDataReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.ViDiagDataReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIDIAGDATA_SERVICEREPLYREGISTRATION_HXX
