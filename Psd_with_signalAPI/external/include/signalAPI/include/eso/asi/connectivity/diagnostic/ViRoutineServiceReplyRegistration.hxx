...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIROUTINE_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIROUTINE_SERVICEREPLYREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::ViRoutineReply interface.
    */
    class ViRoutineServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViRoutineServiceReplyRegistration (const ::comm::InstanceID& _instID, ViRoutineReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViRoutineServiceReplyRegistration (const ::comm::InstanceID& _instID, ViRoutineReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.ViRoutineReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIROUTINE_SERVICEREPLYREGISTRATION_HXX
