...
*/
#ifndef ASI_CONNECTIVITY_AL_HANDSFREESERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_HANDSFREESERVICES_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::HandsfreeServices interface.
    */
    class HandsfreeServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        HandsfreeServicesServiceRegistration (const ::comm::InstanceID& _instID, HandsfreeServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        HandsfreeServicesServiceRegistration (const ::comm::InstanceID& _instID, HandsfreeServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        HandsfreeServicesServiceRegistration (const ::comm::InstanceID& _instID, HandsfreeServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        HandsfreeServicesServiceRegistration (const ::comm::InstanceID& _instID, HandsfreeServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        HandsfreeServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_HANDSFREESERVICES_SERVICEREGISTRATION_HXX
