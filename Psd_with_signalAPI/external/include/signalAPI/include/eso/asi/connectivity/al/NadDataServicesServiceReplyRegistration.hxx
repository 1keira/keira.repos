...
*/
#ifndef ASI_CONNECTIVITY_AL_NADDATASERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADDATASERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadDataServicesReply interface.
    */
    class NadDataServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadDataServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadDataServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadDataServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NadDataServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.NadDataServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_NADDATASERVICES_SERVICEREPLYREGISTRATION_HXX
