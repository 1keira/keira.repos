...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIDIAGDATA_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIDIAGDATA_SERVICEREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::ViDiagData interface.
    */
    class ViDiagDataServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViDiagDataServiceRegistration (const ::comm::InstanceID& _instID, ViDiagDataS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViDiagDataServiceRegistration (const ::comm::InstanceID& _instID, ViDiagDataS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ViDiagDataServiceRegistration (const ::comm::InstanceID& _instID, ViDiagDataS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        ViDiagDataServiceRegistration (const ::comm::InstanceID& _instID, ViDiagDataS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIDIAGDATA_SERVICEREGISTRATION_HXX
