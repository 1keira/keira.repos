...
*/
#ifndef ASI_CONNECTIVITY_AL_MESSAGING_DEFINITIONS_CSTYLE_HXX
#define ASI_CONNECTIVITY_AL_MESSAGING_DEFINITIONS_CSTYLE_HXX
...
namespace asi { namespace connectivity { namespace al { namespace messaging { namespace cstyle {
...
// Streaming operators for all enum arrays
        ...
        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::MessagingErrorCode  e)
        {
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::MessagingErrorCode & e)
        {
            int32_t value;
            ...
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::MessagingErrorCode) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::MapMessagePriority  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::MapMessagePriority & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::MapMessagePriority) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::MapMessageType  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::MapMessageType & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::MapMessageType) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::MapAccountFeature  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::MapAccountFeature & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::MapAccountFeature) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::MapModifyText  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::MapModifyText & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::MapModifyText) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::MapSentStatus  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::MapSentStatus & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::MapSentStatus) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::NumberingScheme  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::NumberingScheme & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::NumberingScheme) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::SmsStorage  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::SmsStorage & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::SmsStorage) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::NadMessageStatus  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::NadMessageStatus & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::NadMessageStatus) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::NadDeleteFlag  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::NadDeleteFlag & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::NadDeleteFlag) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::SendWriteAction  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::SendWriteAction & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::SendWriteAction) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::SimType  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::SimType & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, false /*unsigned */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::SimType) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::SimMode  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::SimMode & e)
        {
            int32_t value;
            ...
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::SimMode) value;
            }
            return error;
        }


        inline bool serialize(IStructuredSerializer& s, const asi::connectivity::al::messaging::cstyle::SimReady  e)
        {
            int32_t value = int32_t(e);
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, asi::connectivity::al::messaging::cstyle::SimReady & e)
        {
            int32_t value;
            bool error = s.getEnum(value, 32, true /* signed */);
            if (!error) {
                ...
                e = (asi::connectivity::al::messaging::cstyle::SimReady) value;
            }
            return error;
        }
...
#endif  // ASI_CONNECTIVITY_AL_MESSAGING_DEFINITIONS_CSTYLE_HXX
