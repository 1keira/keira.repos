...
*/
#ifndef ASI_CONNECTIVITY_AL_MESSAGING_MAPSETUP_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_MESSAGING_MAPSETUP_SERVICEREGISTRATION_HXX
...
namespace messaging
{
    ...
    /**
        \brief The service registration instance for the messaging::MapSetup interface.
    */
    class MapSetupServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        MapSetupServiceRegistration (const ::comm::InstanceID& _instID, MapSetupS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        MapSetupServiceRegistration (const ::comm::InstanceID& _instID, MapSetupS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        MapSetupServiceRegistration (const ::comm::InstanceID& _instID, MapSetupS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        MapSetupServiceRegistration (const ::comm::InstanceID& _instID, MapSetupS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
...
#endif// ASI_CONNECTIVITY_AL_MESSAGING_MAPSETUP_SERVICEREGISTRATION_HXX
