...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_SERVICEREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticViMeasurements interface.
    */
    class DiagnosticViMeasurementsServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticViMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticViMeasurementsS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticViMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticViMeasurementsS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        DiagnosticViMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticViMeasurementsS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        DiagnosticViMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticViMeasurementsS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        DiagnosticViMeasurementsServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_SERVICEREGISTRATION_HXX
