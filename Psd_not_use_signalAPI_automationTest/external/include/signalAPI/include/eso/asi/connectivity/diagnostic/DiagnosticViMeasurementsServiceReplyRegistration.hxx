...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticViMeasurementsReply interface.
    */
    class DiagnosticViMeasurementsServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticViMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticViMeasurementsReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticViMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticViMeasurementsReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.DiagnosticViMeasurementsReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
