...
*/
#ifndef ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_PROXY_HXX
#define ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_PROXY_HXX
...
#include <asi/connectivity/al/NadMessagingServicesC.hxx>
#include <asi/connectivity/al/NadMessagingServicesReply.hxx>
#include <asi/connectivity/al/NadMessagingServicesServiceReplyRegistration.hxx>
...
namespace al
{
    ...
    /**
        \brief A proxy for services that implement the al::NadMessagingServices interface.
    */
    ...
    public:
        ...
        : Proxy(comm::Proxy::IdentityArgs(
                comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_REQUEST), inst_cnt)
                ,getIKey(), getIName())
                ,clientInitFactory
                ,comm::CIPtrStyle
                ,l)
        ...
        : Proxy(comm::Proxy::IdentityArgs(id, getIKey(), getIName())
                ...
                ,NadMessagingServicesServiceReplyRegistration(
                    comm::InstanceID(comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_REPLY))
                    ,r
                    ,nullptr
                    )
                ,comm::CIPtrStyle
        ...
        // ctor with reply instance reference and listener pointer and ActiveObjectFactory
        NadMessagingServicesProxy(const uint32_t inst_cnt, NadMessagingServicesReply& r, comm::ActiveObjectFactoryPtr aof, comm::LifecycleListener* l=nullptr)
        : Proxy(comm::Proxy::IdentityArgs(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_REQUEST), inst_cnt)
                ,getIKey(), getIName())
                ,clientInitFactory
            ,NadMessagingServicesServiceReplyRegistration(
                comm::InstanceID(comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_REPLY))
...
#endif// ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_PROXY_HXX
