...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICROUTINESS_CSTYLE_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICROUTINESS_CSTYLE_HXX
...
#include <asi/connectivity/diagnostic/cstyle/DiagnosticRoutinesServiceRegistration.hxx>
...
#include <asi/connectivity/diagnostic/cstyle/DiagnosticRoutinesProxyReply.hxx>
...
namespace cstyle
{
    ...
    /**
    \brief  The diagnostic::cstyle::DiagnosticRoutines interface on tthe service side.
    \details
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICROUTINESS_CSTYLE_HXX
