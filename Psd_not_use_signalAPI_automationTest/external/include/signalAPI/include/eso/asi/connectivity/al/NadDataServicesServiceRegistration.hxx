...
*/
#ifndef ASI_CONNECTIVITY_AL_NADDATASERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADDATASERVICES_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadDataServices interface.
    */
    class NadDataServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadDataServicesServiceRegistration (const ::comm::InstanceID& _instID, NadDataServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadDataServicesServiceRegistration (const ::comm::InstanceID& _instID, NadDataServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        NadDataServicesServiceRegistration (const ::comm::InstanceID& _instID, NadDataServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        NadDataServicesServiceRegistration (const ::comm::InstanceID& _instID, NadDataServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        NadDataServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_NADDATASERVICES_SERVICEREGISTRATION_HXX
