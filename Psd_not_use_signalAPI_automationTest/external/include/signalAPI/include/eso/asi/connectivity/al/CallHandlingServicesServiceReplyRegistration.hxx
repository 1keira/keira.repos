...
*/
#ifndef ASI_CONNECTIVITY_AL_CALLHANDLINGSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_CALLHANDLINGSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::CallHandlingServicesReply interface.
    */
    class CallHandlingServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        CallHandlingServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, CallHandlingServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        CallHandlingServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, CallHandlingServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.CallHandlingServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_CALLHANDLINGSERVICES_SERVICEREPLYREGISTRATION_HXX
