...
*/
#ifndef ASI_CONNECTIVITY_AL_NADINFORMATIONSERVICE_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADINFORMATIONSERVICE_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadInformationServiceReply interface.
    */
    class NadInformationServiceServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadInformationServiceServiceReplyRegistration (const ::comm::InstanceID& _instID, NadInformationServiceReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadInformationServiceServiceReplyRegistration (const ::comm::InstanceID& _instID, NadInformationServiceReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.NadInformationServiceReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_NADINFORMATIONSERVICE_SERVICEREPLYREGISTRATION_HXX
