...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVTTMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVTTMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticVttMeasurementsReply interface.
    */
    class DiagnosticVttMeasurementsServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticVttMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticVttMeasurementsReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticVttMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticVttMeasurementsReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.DiagnosticVttMeasurementsReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVTTMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
