...
*/
#ifndef ASI_CONNECTIVITY_AL_NADAUDIOSERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADAUDIOSERVICES_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadAudioServices interface.
    */
    class NadAudioServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadAudioServicesServiceRegistration (const ::comm::InstanceID& _instID, NadAudioServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadAudioServicesServiceRegistration (const ::comm::InstanceID& _instID, NadAudioServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        NadAudioServicesServiceRegistration (const ::comm::InstanceID& _instID, NadAudioServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        NadAudioServicesServiceRegistration (const ::comm::InstanceID& _instID, NadAudioServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        NadAudioServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_NADAUDIOSERVICES_SERVICEREGISTRATION_HXX
