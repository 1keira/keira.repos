...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDTCSS_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDTCSS_HXX
...
#include <asi/connectivity/diagnostic/DiagnosticDtcsServiceRegistration.hxx>
#include <asi/connectivity/diagnostic/StructDtc.hxx>

#include <asi/connectivity/diagnostic/Definitions.hxx>

#include <asi/connectivity/diagnostic/DiagnosticDtcsProxyReply.hxx>
#include <asi/connectivity/diagnostic/DiagnosticDtcsReplyS.hxx>
    ...
    // List of request methods
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            DiagnosticDtcsServiceRegistration tmp{m_registration};
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDTCSS_HXX
