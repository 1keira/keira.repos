...
*/
#ifndef ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::CallStackServicesReply interface.
    */
    class CallStackServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        CallStackServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, CallStackServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        CallStackServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, CallStackServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.CallStackServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_SERVICEREPLYREGISTRATION_HXX
