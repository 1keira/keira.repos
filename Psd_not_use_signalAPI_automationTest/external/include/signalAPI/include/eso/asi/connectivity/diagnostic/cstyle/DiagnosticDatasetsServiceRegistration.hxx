...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETS_SERVICEREGISTRATION_CSTYLE_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETS_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticDatasets interface.
    */
    class DiagnosticDatasetsServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticDatasetsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticDatasetsS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticDatasetsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticDatasetsS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        DiagnosticDatasetsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticDatasetsS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        DiagnosticDatasetsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticDatasetsS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        DiagnosticDatasetsServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICDATASETS_SERVICEREGISTRATION_HXX
