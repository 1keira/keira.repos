...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICROUTINES_SERVICEREGISTRATION_CSTYLE_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICROUTINES_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticRoutines interface.
    */
    class DiagnosticRoutinesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticRoutinesServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticRoutinesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticRoutinesServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticRoutinesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        DiagnosticRoutinesServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticRoutinesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        DiagnosticRoutinesServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticRoutinesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        DiagnosticRoutinesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICROUTINES_SERVICEREGISTRATION_HXX
