...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_SERVICEREPLYREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::ViMeasurementReply interface.
    */
    class ViMeasurementServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViMeasurementServiceReplyRegistration (const ::comm::InstanceID& _instID, ViMeasurementReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViMeasurementServiceReplyRegistration (const ::comm::InstanceID& _instID, ViMeasurementReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.ViMeasurementReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIMEASUREMENT_SERVICEREPLYREGISTRATION_HXX
