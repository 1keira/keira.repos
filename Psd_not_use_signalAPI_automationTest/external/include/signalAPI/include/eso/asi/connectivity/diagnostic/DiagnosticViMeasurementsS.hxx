...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTSS_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTSS_HXX
...
#include <asi/connectivity/diagnostic/DiagnosticViMeasurementsServiceRegistration.hxx>

#include <asi/connectivity/diagnostic/Definitions.hxx>

#include <asi/connectivity/diagnostic/DiagnosticViMeasurementsProxyReply.hxx>
#include <asi/connectivity/diagnostic/DiagnosticViMeasurementsReplyS.hxx>
...
namespace diagnostic
{
    ...
    **/
    class DiagnosticViMeasurementsS
    {
    public:
        DiagnosticViMeasurementsS () {}
    // List of request methods
        ...
        **/
        virtual void getHostnameRegisterPairing(
            
            DiagnosticViMeasurementsProxyReply& reply
        ) = 0;
        /**
            \brief
        ...
        */
        bool registerSelf(uint32_t instance_no, const comm::ActiveObjectFactoryPtr& factory, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                DiagnosticViMeasurementsServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_REQUEST), instance_no), static_cast<DiagnosticViMeasurementsS*>(this), l, factory );
        ...
        */
        bool registerSelf(uint32_t instance_no, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                DiagnosticViMeasurementsServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTS_REQUEST), instance_no), static_cast<DiagnosticViMeasurementsS*>(this), l );
            if (!m_registration.valid()) {
                comm::error::fatal( "can't create ServiceRegistration, OOM ", COMM_HERE);
                return true;
            }
        ...
        */
        bool unregisterSelf()
        {
            ...
            m_registration = DiagnosticViMeasurementsServiceRegistration();
            return false;
        }
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            DiagnosticViMeasurementsServiceRegistration tmp{m_registration};
        ...
        virtual ~DiagnosticViMeasurementsS()
        {
        ...
        // call ids
        void
        getHostnameRegisterPairingCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<DiagnosticViMeasurementsS*>(this);
    ...
    protected:
        DiagnosticViMeasurementsServiceRegistration m_registration;
    };

} //namespace asi
} //namespace connectivity
} //namespace diagnostic
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTSS_HXX
