...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIDTC_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIDTC_SERVICEREPLYREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    class ViDtcReply;
    /**
        \brief The service registration instance for the diagnostic::ViDtcReply interface.
    */
    class ViDtcServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViDtcServiceReplyRegistration (const ::comm::InstanceID& _instID, ViDtcReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViDtcServiceReplyRegistration (const ::comm::InstanceID& _instID, ViDtcReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.ViDtcReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIDTC_SERVICEREPLYREGISTRATION_HXX
