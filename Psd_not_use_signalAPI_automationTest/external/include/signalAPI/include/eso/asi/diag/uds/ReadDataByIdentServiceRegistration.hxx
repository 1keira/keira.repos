...
*/
#ifndef ASI_DIAG_UDS_READDATABYIDENT_SERVICEREGISTRATION_HXX
#define ASI_DIAG_UDS_READDATABYIDENT_SERVICEREGISTRATION_HXX
...
namespace uds
{
    ...
    /**
        \brief The service registration instance for the uds::ReadDataByIdent interface.
    */
    class ReadDataByIdentServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ReadDataByIdentServiceRegistration (const ::comm::InstanceID& _instID, ReadDataByIdentS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ReadDataByIdentServiceRegistration (const ::comm::InstanceID& _instID, ReadDataByIdentS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ReadDataByIdentServiceRegistration (const ::comm::InstanceID& _instID, ReadDataByIdentS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        ReadDataByIdentServiceRegistration (const ::comm::InstanceID& _instID, ReadDataByIdentS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        ReadDataByIdentServiceRegistration() {}
...
#endif// ASI_DIAG_UDS_READDATABYIDENT_SERVICEREGISTRATION_HXX
