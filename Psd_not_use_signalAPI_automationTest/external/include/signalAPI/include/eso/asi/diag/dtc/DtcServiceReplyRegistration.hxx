...
*/
#ifndef ASI_DIAG_DTC_DTC_SERVICEREPLYREGISTRATION_HXX
#define ASI_DIAG_DTC_DTC_SERVICEREPLYREGISTRATION_HXX
...
namespace dtc
{
    ...
    class DtcReply;
    /**
        \brief The service registration instance for the dtc::DtcReply interface.
    */
    class DtcServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DtcServiceReplyRegistration (const ::comm::InstanceID& _instID, DtcReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DtcServiceReplyRegistration (const ::comm::InstanceID& _instID, DtcReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.diag.dtc.DtcReply"};
            return iname;
        }
...
#endif// ASI_DIAG_DTC_DTC_SERVICEREPLYREGISTRATION_HXX
