...
*/
#ifndef ASI_DIAG_DTC_DTC_SERVICEREGISTRATION_HXX
#define ASI_DIAG_DTC_DTC_SERVICEREGISTRATION_HXX
...
namespace dtc
{
    ...
    /**
        \brief The service registration instance for the dtc::Dtc interface.
    */
    class DtcServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DtcServiceRegistration (const ::comm::InstanceID& _instID, DtcS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DtcServiceRegistration (const ::comm::InstanceID& _instID, DtcS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        DtcServiceRegistration (const ::comm::InstanceID& _instID, DtcS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        DtcServiceRegistration (const ::comm::InstanceID& _instID, DtcS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
...
#endif// ASI_DIAG_DTC_DTC_SERVICEREGISTRATION_HXX
