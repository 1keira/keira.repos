...
*/
#ifndef ASI_SID_LHWAPP_INTLHWAPP_REPLYS_HXX
#define ASI_SID_LHWAPP_INTLHWAPP_REPLYS_HXX
    ...
    **/
    ...
    public:
         ...
         ***
            ...
            **/
        virtual bool updateAirbag01 (
            const CIPtr< asi::sid::lhwapp::Airbag01Struct >& Airbag01,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
        ...
        virtual bool updateBlinkmodi02 (
            const CIPtr< asi::sid::lhwapp::Blinkmodi02Struct >& Blinkmodi02,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updateDaempfer01 (
            const CIPtr< asi::sid::lhwapp::Daempfer01Struct >& Daempfer01,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
        ...
        virtual bool updateESC50 (
            const CIPtr< asi::sid::lhwapp::ESC50Struct >& ESC50,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
        ...
        virtual bool updateESP21 (
            const CIPtr< asi::sid::lhwapp::ESP21Struct >& ESP21,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
        ...
        virtual bool updateESP24 (
            const CIPtr< asi::sid::lhwapp::ESP24Struct >& ESP24,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updateESP30 (
            const CIPtr< asi::sid::lhwapp::ESP30Struct >& ESP30,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updateHVK01 (
            const CIPtr< asi::sid::lhwapp::HVK01Struct >& HVK01,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updateMotor18 (
            const CIPtr< asi::sid::lhwapp::Motor18Struct >& Motor18,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updateMotor_41 (
            const CIPtr< asi::sid::lhwapp::Motor41Struct >& Motor_41,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updatePOSGNSSDR01 (
            const CIPtr< asi::sid::lhwapp::POSGNSSDR01Struct >& POSGNSSDR01,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updatePSD04 (
            const CIPtr< asi::sid::lhwapp::PSD04Struct >& PSD04,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updatePSD05 (
            const CIPtr< asi::sid::lhwapp::PSD05Struct >& PSD05,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updatePSD06 (
            const CIPtr< asi::sid::lhwapp::PSD06Struct >& PSD06,
            const bool isValid
        ) IPL_NOEXCEPT = 0;
         ...
         ***
            ...
            **/
        virtual bool updateRKA01 (
            const CIPtr< asi::sid::lhwapp::RKA01Struct >& RKA01,
            const bool isValid
        ) IPL_NOEXCEPT = 0;

        virtual ~IntLHWAppReplyS() {}
    };
...
#endif// ASI_SID_LHWAPP_INTLHWAPP_REPLYS_HXX
