...
*/
#ifndef ASI_SID_V2XSTACK_INTV2XSTACKREPLY_CSTYLE_HXX
#define ASI_SID_V2XSTACK_INTV2XSTACKREPLY_CSTYLE_HXX
    ...
    **/
    ...
    // List of reply methods
        ...
        virtual void updateESC50(
            const asi::sid::v2xstack::cstyle::ESC50Struct* ESC50,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateEBKV03Auth(
            const asi::sid::v2xstack::cstyle::EBKV03AuthStruct* EBKV03Auth,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateESC51Auth(
            const asi::sid::v2xstack::cstyle::ESC51AuthStruct* ESC51Auth,
            const bool isValid
        ) = 0;
            /**
            \brief
        ...
        virtual void updateESP21(
            const asi::sid::v2xstack::cstyle::ESP21Struct* ESP21,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateLichtAnf01(
            const asi::sid::v2xstack::cstyle::LichtAnf01Struct* LichtAnf01,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateLichtvorne01(
            const asi::sid::v2xstack::cstyle::Lichtvorne01Struct* Lichtvorne01,
            const bool isValid
        ) = 0;
            /**
            \brief
        ...
        virtual void updateBlinkmodi02(
            const asi::sid::v2xstack::cstyle::Blinkmodi02Struct* Blinkmodi02,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateVMM02Auth(
            const asi::sid::v2xstack::cstyle::VMM02AuthStruct* VMM02Auth,
            const bool isValid
        ) = 0;
            /**
            \brief
        ...
        virtual void updateESP24(
            const asi::sid::v2xstack::cstyle::ESP24Struct* ESP24,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateMotor14(
            const asi::sid::v2xstack::cstyle::Motor14Struct* Motor14,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateLWI01(
            const asi::sid::v2xstack::cstyle::LWI01Struct* LWI01,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateGetriebe11(
            const asi::sid::v2xstack::cstyle::Getriebe11Struct* Getriebe11,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updateKlemmenStatus01(
            const asi::sid::v2xstack::cstyle::KlemmenStatus01Struct* KlemmenStatus01,
            const bool isValid
        ) = 0;
            /**
            \brief
         ...
         ***
            ...
            **/
        virtual void updatePersonalisierung01(
            const asi::sid::v2xstack::cstyle::Personalisierung01Struct* Personalisierung01,
            const bool isValid
        ) = 0;
        ...
        */
        ...
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
        ...
        void
        updateEBKV03AuthCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateESC51AuthCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateLichtAnf01CallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateLichtvorne01CallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateVMM02AuthCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateMotor14CallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateLWI01CallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateGetriebe11CallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updateKlemmenStatus01CallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        updatePersonalisierung01CallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<IntV2XStackReply*>(this);
            // Don't ever rely on these values outside of a CallID
...
#endif// ASI_SID_V2XSTACK_INTV2XSTACKREPLY_CSTYLE_HXX
