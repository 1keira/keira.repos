...
*/
#ifndef ASI_SID_V2XSTACK_ESP24STRUCT_CSTYLE_HXX
#define ASI_SID_V2XSTACK_ESP24STRUCT_CSTYLE_HXX
...
bool serialize (util::serializer::IStructuredSerializer &ser, const asi::sid::v2xstack::cstyle::ESP24Struct& val);
bool deserialize (util::serializer::IStructuredPullDeserializer &s, asi::sid::v2xstack::cstyle::ESP24Struct &val);
}
}
...
namespace  cstyle
{
    ...
    /**
    \brief struct v2xstack::ESP24Struct.
    */
    struct PROXY_EXPORT ESP24Struct
    {
        ...
        uint64_t m_PduState;
    private:
        friend bool util::serializer::serialize (util::serializer::IStructuredSerializer &s, const asi::sid::v2xstack::cstyle::ESP24Struct& val);
        friend bool util::serializer::deserialize (util::serializer::IStructuredPullDeserializer &s, asi::sid::v2xstack::cstyle::ESP24Struct &val);
    };
...
#endif// ASI_SID_V2XSTACK_ESP24STRUCT_CSTYLE_HXX
