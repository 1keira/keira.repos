...
*/
#ifndef ASI_VEHICLE_TESTS_HXX
#define ASI_VEHICLE_TESTS_HXX
...
#include <asi/vehicle/TestServiceRegistration.hxx>
#include <asi/vehicle/StructKlemmenStatus01Struct.hxx>

#include <asi/vehicle/Definitions.hxx>

#include <asi/vehicle/TestProxyReply.hxx>
#include <asi/vehicle/TestReplyS.hxx>
    ...
    // List of request methods
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            TestServiceRegistration tmp{m_registration};
