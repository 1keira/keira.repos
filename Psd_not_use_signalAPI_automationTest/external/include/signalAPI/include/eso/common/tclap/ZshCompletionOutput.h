...
class ZshCompletionOutput : public CmdLineOutput
{
    ...
    public:
        ...
        ZshCompletionOutput() IPL_NOEXCEPT;
         ...
         */
        virtual void usage(CmdLineInterface& c) IPL_NOEXCEPT;
         ...
         * \param c - The CmdLine object the output is generated for. 
         */
        virtual void version(CmdLineInterface& c) IPL_NOEXCEPT;

    protected:

        void basename( std::string& s ) IPL_NOEXCEPT;
        void quoteSpecialChars( std::string& s ) IPL_NOEXCEPT;

        std::string getMutexList( CmdLineInterface& _cmd, Arg* a ) IPL_NOEXCEPT;
        void printOption( Arg* it, std::string mutex ) IPL_NOEXCEPT;
        void printArg( Arg* it ) IPL_NOEXCEPT;

        std::map<std::string, std::string> common;
        char theDelimiter;
};

ZshCompletionOutput::ZshCompletionOutput() IPL_NOEXCEPT
...
inline void ZshCompletionOutput::version(CmdLineInterface& _cmd) IPL_NOEXCEPT
{
    std::cout << _cmd.getVersion() << std::endl;
}

inline void ZshCompletionOutput::usage(CmdLineInterface& _cmd ) IPL_NOEXCEPT
{
...
inline void ZshCompletionOutput::quoteSpecialChars( std::string& s ) IPL_NOEXCEPT
{
...
inline void ZshCompletionOutput::basename( std::string& s ) IPL_NOEXCEPT
{
...
inline void ZshCompletionOutput::printArg(Arg* a) IPL_NOEXCEPT
{
    static int count = 1;
...
inline void ZshCompletionOutput::printOption(Arg* a, std::string mutex) IPL_NOEXCEPT
{
...
inline std::string ZshCompletionOutput::getMutexList( CmdLineInterface& _cmd, Arg* a) IPL_NOEXCEPT
{
