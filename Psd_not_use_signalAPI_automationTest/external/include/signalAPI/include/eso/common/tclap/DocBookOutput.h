...
class DocBookOutput : public CmdLineOutput
{
    ...
    public:
        ...
        DocBookOutput() IPL_NOEXCEPT : theDelimiter('=') {}
    protected:
         ...
         */
        void substituteSpecialChars( std::string& s, char r, std::string& x ) IPL_NOEXCEPT;
        void removeChar( std::string& s, char r) IPL_NOEXCEPT;
        void basename( std::string& s ) IPL_NOEXCEPT;

        void printShortArg(Arg* it) IPL_NOEXCEPT;
        void printLongArg(Arg* it) IPL_NOEXCEPT;

        char theDelimiter;
};


inline void DocBookOutput::version(CmdLineInterface& _cmd) IPL_NOEXCEPT 
{ 
    std::cout << _cmd.getVersion() << std::endl;
}

inline void DocBookOutput::usage(CmdLineInterface& _cmd ) IPL_NOEXCEPT 
{
...
inline void DocBookOutput::removeChar( std::string& s, char r) IPL_NOEXCEPT
{
    size_t p;
    while ( (p = s.find_first_of(r)) != std::string::npos )
    {
...
inline void DocBookOutput::basename( std::string& s ) IPL_NOEXCEPT
{
...
inline void DocBookOutput::printShortArg(Arg* a) IPL_NOEXCEPT
{
    std::string lt = "&lt;"; 
    std::string gt = "&gt;"; 
...
inline void DocBookOutput::printLongArg(Arg* a) IPL_NOEXCEPT
{
    std::string lt = "&lt;"; 
    std::string gt = "&gt;"; 
