...
{ 
    ...
    OptionalUnlabeledTracker::check(req, UnlabeledValueArg<T>::toString());
 ...
 */
template<class T>
bool UnlabeledValueArg<T>::processArg(int *i, std::vector<std::string>& args) IPL_NOEXCEPT 
{
 ...
 */
template<class T>
std::string UnlabeledValueArg<T>::shortID(const std::string& val) const IPL_NOEXCEPT
{
 ...
 */
template<class T>
std::string UnlabeledValueArg<T>::longID(const std::string& val) const IPL_NOEXCEPT
{
    static_cast<void>(val); // Ignore input, don't warn
 ...
 */
template<class T>
bool UnlabeledValueArg<T>::operator==(const Arg& a ) const IPL_NOEXCEPT
{
...
template<class T>
void UnlabeledValueArg<T>::addToList( std::list<Arg*>& argList ) const IPL_NOEXCEPT
{
