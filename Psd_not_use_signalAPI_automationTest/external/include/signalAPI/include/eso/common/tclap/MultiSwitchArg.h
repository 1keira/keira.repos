...
class MultiSwitchArg : public SwitchArg
{
    ...
    public:
         ...
         */
        int getValue() IPL_NOEXCEPT;

        /**
         * Returns the shortID for this Arg.
         */
        std::string shortID(const std::string& val) const IPL_NOEXCEPT;

        /**
         * Returns the longID for this Arg.
         */
        std::string longID(const std::string& val) const IPL_NOEXCEPT;
...
inline int MultiSwitchArg::getValue() IPL_NOEXCEPT { return _value; }

inline bool MultiSwitchArg::processArg(int *i, std::vector<std::string>& args) IPL_NOEXCEPT
{
...
inline std::string 
MultiSwitchArg::shortID(const std::string& val) const IPL_NOEXCEPT
{
    return Arg::shortID(val) + " ... ";
}

inline std::string 
MultiSwitchArg::longID(const std::string& val) const IPL_NOEXCEPT
{
    return Arg::longID(val) + "  (accepted multiple times)";
}

inline void
MultiSwitchArg::reset() IPL_NOEXCEPT
{
