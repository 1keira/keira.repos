...
*/
#ifndef PERSISTENCE_IPERSISTENCEB_SERVICEREGISTRATION_HXX
#define PERSISTENCE_IPERSISTENCEB_SERVICEREGISTRATION_HXX
...
namespace persistence
{
    ...
    /**
        \brief The service registration instance for the persistence::IPersistenceB interface.
    */
    class IPersistenceBServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        IPersistenceBServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceBS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        IPersistenceBServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceBS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        IPersistenceBServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceBS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        IPersistenceBServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceBS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        IPersistenceBServiceRegistration() {}
...
#endif// PERSISTENCE_IPERSISTENCEB_SERVICEREGISTRATION_HXX
