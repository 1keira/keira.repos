...
*/
#ifndef PERSISTENCE_IPERSISTENCEAS_CSTYLE_HXX
#define PERSISTENCE_IPERSISTENCEAS_CSTYLE_HXX
...
#include <persistence/cstyle/IPersistenceAServiceRegistration.hxx>
#include <persistence/cstyle/StructPartitionHandle.hxx>
#include <persistence/cstyle/Definitions.hxx>
#include <persistence/cstyle/IPersistenceAProxyReply.hxx>
#include <persistence/cstyle/IPersistenceAReplyS.hxx>
...
namespace cstyle
{
    ...
    /**
    \brief  The persistence::cstyle::IPersistenceA interface on tthe service side.
    \details
...
#endif// PERSISTENCE_IPERSISTENCEAS_CSTYLE_HXX
