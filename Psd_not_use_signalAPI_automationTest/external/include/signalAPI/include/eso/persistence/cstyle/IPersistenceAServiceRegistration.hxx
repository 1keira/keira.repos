...
*/
#ifndef PERSISTENCE_IPERSISTENCEA_SERVICEREGISTRATION_CSTYLE_HXX
#define PERSISTENCE_IPERSISTENCEA_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the persistence::IPersistenceA interface.
    */
    class IPersistenceAServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        IPersistenceAServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceAS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        IPersistenceAServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceAS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        IPersistenceAServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceAS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        IPersistenceAServiceRegistration (const ::comm::InstanceID& _instID, IPersistenceAS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        IPersistenceAServiceRegistration() {}
...
#endif// PERSISTENCE_IPERSISTENCEA_SERVICEREGISTRATION_HXX
