...
*/
#ifndef COMM_BROKER_DEFINITIONS_HXX
#define COMM_BROKER_DEFINITIONS_HXX
...
namespace comm { namespace broker { 
    // comm::broker
    enum ServiceReason {
...
#define BINARY_IFC_KEY_COMM_BROKER_BROKER_REQUEST comm::InterfaceKey(0x00040000, 0x0001, 0x6000, 0x0000, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00)
#define STRING_IFC_KEY_COMM_BROKER_BROKER_REQUEST ipl::string("00040000-0001-6000-0000-000300000000")
...
// semver encoded as a UUID (non standard version 6)
#define BINARY_IFC_KEY_COMM_BROKER_AGENT_REQUEST comm::InterfaceKey(0x00040000, 0x0001, 0x6000, 0x0000, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00)
#define STRING_IFC_KEY_COMM_BROKER_AGENT_REQUEST ipl::string("00040000-0001-6000-0000-000400000000")
...
namespace util { namespace serializer {
            inline bool serialize(IStructuredSerializer& s, const comm::broker::ServiceReason  e)
            {
            ...
            inline bool deserialize(IStructuredPullDeserializer& s, comm::broker::ServiceReason & e)
            {
                int32_t value;
                ...
                if (!error) {
                    ...
                    e = (comm::broker::ServiceReason) value;
                }
                return error;
            }
            inline bool serialize(IStructuredSerializer& s, const comm::broker::ServiceAction  e)
            {
                int32_t value = int32_t(e);
            ...
            inline bool deserialize(IStructuredPullDeserializer& s, comm::broker::ServiceAction & e)
            {
                int32_t value;
                bool error = s.getEnum(value, 32, false /*unsigned */);
                if (!error) {
                    ...
                    e = (comm::broker::ServiceAction) value;
                }
                return error;
            }
