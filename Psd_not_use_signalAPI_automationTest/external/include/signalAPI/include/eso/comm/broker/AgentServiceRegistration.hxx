...
*/
#ifndef COMM_BROKER_AGENT_SERVICEREGISTRATION_HXX
#define COMM_BROKER_AGENT_SERVICEREGISTRATION_HXX
...
namespace broker
{
    ...
    /**
        \brief The service registration instance for the broker::Agent interface.
    */
    class AgentServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        AgentServiceRegistration (const ::comm::InstanceID& _instID, AgentS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        AgentServiceRegistration (const ::comm::InstanceID& _instID, AgentS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        AgentServiceRegistration (const ::comm::InstanceID& _instID, AgentS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        AgentServiceRegistration (const ::comm::InstanceID& _instID, AgentS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
...
#endif// COMM_BROKER_AGENT_SERVICEREGISTRATION_HXX
