...
inline void DefaultSerializerBE::serialize(uint8_t *to, PRIM from) IPL_NOEXCEPT
{
    for( uint_fast8_t byte = 0; byte < sizeof(from); byte++ )
    {
        to[sizeof(from) - byte - 1] = (uint8_t)(from >> (byte * 8));
    }
}

inline IStreamSerializer& DefaultSerializerBE::operator<<(int16_t val) IPL_NOEXCEPT
{
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(uint16_t val) IPL_NOEXCEPT
{
    return operator<<(static_cast<int16_t>(val));
}

inline IStreamSerializer& DefaultSerializerBE::operator<<(int32_t val) IPL_NOEXCEPT
{
    const size_t pos = this->prepareVal(val);
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(uint32_t val) IPL_NOEXCEPT
{
    return operator<<(static_cast<int32_t>(val));
}

inline IStreamSerializer& DefaultSerializerBE::operator<<(int64_t val) IPL_NOEXCEPT
{
    const size_t pos = this->prepareVal(val);

    if( m_state != CALC && ! hasError() )
        serialize( (uint8_t*)&m_data[pos], val );

    return *(static_cast<IStreamSerializer*>(this));
}

inline IStreamSerializer& DefaultSerializerBE::operator<<(uint64_t val) IPL_NOEXCEPT
{
    return operator<<(static_cast<int64_t>(val));
}

inline IStreamSerializer& DefaultSerializerBE::operator<<(float val) IPL_NOEXCEPT
{
    ...
    // think hard how to actually parametrize the format string (not to speak of java) to
    ...
    if( m_state != CALC && ! hasError() )
    {
        ...
        serialize( (uint8_t*)&m_data[pos], *(uint32_t*)val_ptr );
    }
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(double val) IPL_NOEXCEPT
{
    ...
    {
        void *val_ptr = &val;
        serialize( (uint8_t*)&m_data[pos], *(uint64_t*)val_ptr );
    }

    return *(static_cast<IStreamSerializer*>(this));
}

inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<int16_t> &a) IPL_NOEXCEPT
{
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<uint16_t> &a) IPL_NOEXCEPT
{
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<int32_t> &a) IPL_NOEXCEPT
{
    size_t pos = this->prepareArray(a);
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<uint32_t> &a) IPL_NOEXCEPT
{
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<int64_t> &a) IPL_NOEXCEPT
{
    size_t pos = this->prepareArray(a);
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<uint64_t> &a) IPL_NOEXCEPT
{
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<float> &a) IPL_NOEXCEPT
{
    size_t pos = this->prepareArray(a);
...
inline IStreamSerializer& DefaultSerializerBE::operator<<(const serializer::Array<double> &a) IPL_NOEXCEPT
{
    size_t pos = this->prepareArray(a);
