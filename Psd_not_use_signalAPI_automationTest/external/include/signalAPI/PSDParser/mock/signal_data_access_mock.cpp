 ...
 *
 * \brief Generated mock implementation for signal data access API specific for application PSDParser
 *
...
#include <vwg/sid/PSDParser/mock/signal_data_access_mock.hpp>
...
void RxPdu_PSD_04::FOR_TESTING_set_PSD_Idenditaets_ID(std::uint32_t value) noexcept { PSD_Idenditaets_ID_value = value; return; } // 6 bits
void RxPdu_PSD_04::FOR_TESTING_set_PSD_ADAS_Qualitaet(bool value) noexcept { PSD_ADAS_Qualitaet_value = value; return; } // 1 bit
...
void RxPdu_PSD_04::FOR_TESTING_set_PSD_Fahrspuren_Anzahl(std::uint32_t value) noexcept { PSD_Fahrspuren_Anzahl_value = value; return; } // 3 bits
void RxPdu_PSD_04::FOR_TESTING_set_PSD_Bebauung(bool value) noexcept { PSD_Bebauung_value = value; return; } // 1 bit
void RxPdu_PSD_04::FOR_TESTING_set_PSD_Segment_Komplett(bool value) noexcept { PSD_Segment_Komplett_value = value; return; } // 1 bit
void RxPdu_PSD_04::FOR_TESTING_set_PSD_Rampe(std::uint32_t value) noexcept { PSD_Rampe_value = value; return; } // 2 bits
...
void RxPdu_PSD_05::FOR_TESTING_set_PSD_Pos_Inhibitzeit(std::uint32_t value) noexcept { PSD_Pos_Inhibitzeit_value = value; return; } // 5 bits
...
void RxPdu_PSD_05::FOR_TESTING_set_PSD_Pos_Fahrspur(std::uint32_t value) noexcept { PSD_Pos_Fahrspur_value = value; return; } // 3 bits
void RxPdu_PSD_05::FOR_TESTING_set_PSD_Attribut_Segment_ID_05(std::uint32_t value) noexcept { PSD_Attribut_Segment_ID_05_value = value; return; } // 6 bits
...
void RxPdu_PSD_05::FOR_TESTING_set_PSD_Attribut_1_Offset(std::uint32_t value) noexcept { PSD_Attribut_1_Offset_value = value; return; } // 7 bits
...
void RxPdu_PSD_05::FOR_TESTING_set_PSD_Attribut_2_Offset(std::uint32_t value) noexcept { PSD_Attribut_2_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_05::FOR_TESTING_set_PSD_Attribute_Komplett_05(bool value) noexcept { PSD_Attribute_Komplett_05_value = value; return; } // 1 bit
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_06_Mux(std::uint32_t value) noexcept { PSD_06_Mux_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Segment_ID(std::uint32_t value) noexcept { PSD_Sys_Segment_ID_value = value; return; } // 6 bits
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Segment_ID(std::uint32_t value) noexcept { PSD_Ges_Segment_ID_value = value; return; } // 6 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Baum_Laenge_VZ(bool value) noexcept { PSD_Baum_Laenge_VZ_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_Segment_ID(std::uint32_t value) noexcept { PSD_Steigung_1_Segment_ID_value = value; return; } // 6 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Baum_Laenge(std::uint32_t value) noexcept { PSD_Baum_Laenge_value = value; return; } // 25 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Laendercode(std::uint32_t value) noexcept { PSD_Sys_Laendercode_value = value; return; } // 8 bits
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Offset(std::uint32_t value) noexcept { PSD_Ges_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_A_Steigung(std::uint32_t value) noexcept { PSD_Steigung_1_A_Steigung_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Attribut_3_Offset(std::uint32_t value) noexcept { PSD_Attribut_3_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Geschwindigkeit(std::uint32_t value) noexcept { PSD_Ges_Geschwindigkeit_value = value; return; } // 5 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_A_Vorz(bool value) noexcept { PSD_Steigung_1_A_Vorz_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Geschwindigkeit_Einheit(bool value) noexcept { PSD_Sys_Geschwindigkeit_Einheit_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_A_Offset(std::uint32_t value) noexcept { PSD_Steigung_1_A_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Verkehrsrichtung(bool value) noexcept { PSD_Sys_Verkehrsrichtung_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Geometrieguete(std::uint32_t value) noexcept { PSD_Sys_Geometrieguete_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Mapmatchingguete(std::uint32_t value) noexcept { PSD_Sys_Mapmatchingguete_value = value; return; } // 2 bits
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Typ(std::uint32_t value) noexcept { PSD_Ges_Typ_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Alter_Karte(std::uint32_t value) noexcept { PSD_Sys_Alter_Karte_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Spur_Geschw_Begrenzung(std::uint32_t value) noexcept { PSD_Ges_Spur_Geschw_Begrenzung_value = value; return; } // 6 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_B_Steigung(std::uint32_t value) noexcept { PSD_Steigung_1_B_Steigung_value = value; return; } // 7 bits
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Zielfuehrung(bool value) noexcept { PSD_Sys_Zielfuehrung_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_US_State(std::uint32_t value) noexcept { PSD_Sys_US_State_value = value; return; } // 6 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Geschwindigkeit_Gespann(std::uint32_t value) noexcept { PSD_Ges_Geschwindigkeit_Gespann_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Baum_Breite_VZ(bool value) noexcept { PSD_Baum_Breite_VZ_value = value; return; } // 1 bit
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Baum_Breite(std::uint32_t value) noexcept { PSD_Baum_Breite_value = value; return; } // 24 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Geschwindigkeit_Witter(std::uint32_t value) noexcept { PSD_Ges_Geschwindigkeit_Witter_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_B_Vorz(bool value) noexcept { PSD_Steigung_1_B_Vorz_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_B_Offset(std::uint32_t value) noexcept { PSD_Steigung_1_B_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_Geometrien(std::uint32_t value) noexcept { PSD_Sys_Quali_Geometrien_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Geschwindigkeit_Tag_Anf(std::uint32_t value) noexcept { PSD_Ges_Geschwindigkeit_Tag_Anf_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Attribut_4_Offset(std::uint32_t value) noexcept { PSD_Attribut_4_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_Ortsinfo(std::uint32_t value) noexcept { PSD_Sys_Quali_Ortsinfo_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Geschwindigkeit_Tag_Ende(std::uint32_t value) noexcept { PSD_Ges_Geschwindigkeit_Tag_Ende_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_verfuegbar(bool value) noexcept { PSD_Sys_Quali_verfuegbar_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Zielfuehrung_geaendert(bool value) noexcept { PSD_Sys_Zielfuehrung_geaendert_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Geschwindigkeit_Std_Anf(std::uint32_t value) noexcept { PSD_Ges_Geschwindigkeit_Std_Anf_value = value; return; } // 5 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_1_Attribute_kompl(bool value) noexcept { PSD_Steigung_1_Attribute_kompl_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Geometrieguete_erweitert(std::uint32_t value) noexcept { PSD_Sys_Geometrieguete_erweitert_value = value; return; } // 8 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_2_Segment_ID(std::uint32_t value) noexcept { PSD_Steigung_2_Segment_ID_value = value; return; } // 6 bits
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Geschwindigkeit_Std_Ende(std::uint32_t value) noexcept { PSD_Ges_Geschwindigkeit_Std_Ende_value = value; return; } // 5 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Attribut_5_Offset(std::uint32_t value) noexcept { PSD_Attribut_5_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_2_Steigung(std::uint32_t value) noexcept { PSD_Steigung_2_Steigung_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_sonstige_Attribute(std::uint32_t value) noexcept { PSD_Sys_Quali_sonstige_Attribute_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Ueberholverbot(std::uint32_t value) noexcept { PSD_Ges_Ueberholverbot_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_Steigungen(std::uint32_t value) noexcept { PSD_Sys_Quali_Steigungen_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Wechselverkehrszeichen(std::uint32_t value) noexcept { PSD_Ges_Wechselverkehrszeichen_value = value; return; } // 3 bits
...
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_2_Vorz(bool value) noexcept { PSD_Steigung_2_Vorz_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_Strassenkennz(std::uint32_t value) noexcept { PSD_Sys_Quali_Strassenkennz_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Wechselverkehrszeichen_Typ(std::uint32_t value) noexcept { PSD_Wechselverkehrszeichen_Typ_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Baum_Ausrichtung(std::uint32_t value) noexcept { PSD_Baum_Ausrichtung_value = value; return; } // 10 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_2_Offset(std::uint32_t value) noexcept { PSD_Steigung_2_Offset_value = value; return; } // 7 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Gesetzlich_Kategorie(std::uint32_t value) noexcept { PSD_Ges_Gesetzlich_Kategorie_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_Tempolimits(std::uint32_t value) noexcept { PSD_Sys_Quali_Tempolimits_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Attribute_Komplett_06(bool value) noexcept { PSD_Attribute_Komplett_06_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Gesetzlich_Zusatz(std::uint32_t value) noexcept { PSD_Ges_Gesetzlich_Zusatz_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Sys_Quali_Vorfahrtsregelung(std::uint32_t value) noexcept { PSD_Sys_Quali_Vorfahrtsregelung_value = value; return; } // 3 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Verkehrszeichen_Quelle(std::uint32_t value) noexcept { PSD_Ges_Verkehrszeichen_Quelle_value = value; return; } // 2 bits
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Steigung_2_Attribute_kompl(bool value) noexcept { PSD_Steigung_2_Attribute_kompl_value = value; return; } // 1 bit
void RxPdu_PSD_06::FOR_TESTING_set_PSD_Ges_Attribute_Komplett(bool value) noexcept { PSD_Ges_Attribute_Komplett_value = value; return; } // 1 bit
