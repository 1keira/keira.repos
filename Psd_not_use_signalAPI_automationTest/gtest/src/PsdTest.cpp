...
protected:
    ...
    void TerDown()
    {
        PsdLocation::test_PsdLocation(pInstance);
    }
};
...
TEST_F(PsdLocationTest, getPsdAvailable)
{
    ...
    PsdLocation::getInstance()->testinitPsdData();
...
{
    PsdLocation::getInstance()->testcreateDecoderThread();
    PsdLocation::getInstance()->testcreateMapThread();
}
...
protected:
    ...
    void TerDown()
    {
        PsdMessageDecoder::test_PsdMessageDecoder(pInstance);
    }
};
