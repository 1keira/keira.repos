...
//eRealativeDirection
typedef enum eRealativeDirection
{
    Dir_Unclassified = 0, 
    Dir_Unreachable = 1,
    Dir_Oncoming = 2,
    Dir_Ahead = 3,
    Dir_ComingFromLeft = 4, 
    Dir_ComingFromRight = 5, 
    Dir_ComingFromBehind = 6,
    Dir_AwayFromLeft = 7, 
    Dir_AwayFromRight = 8,
    Dir_AwayFromBehind = 9
}RealativeDirection;
...
//private:
     ...
     */
    bool RoMatchSegment(Position3D RoPoint);
     ...
     */
    RealativeDirection calcRelativeDirection(Data2Location data2Location);
