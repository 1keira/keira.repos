...
#ifndef UTIL_UNICODESTRING16_HXX
#define UTIL_UNICODESTRING16_HXX
...
namespace util{
    ...
    **/
    ...
    class UTIL_EXPORT UnicodeString16:
    ...
    public:
        ...
        **/
        ...
        public:
            ...
            **/
            ...
            /**
                \brief destructor
            **/
            virtual ~iterator() IPL_NOEXCEPT;
            /**
                \brief gets the current unicode character
            **/
            virtual UnicodeChar operator*() const IPL_NOEXCEPT;
            /**
                \brief advances the iterator and returns the advanced one
            **/
            virtual iterator& operator++() IPL_NOEXCEPT;
            /**
        ...
        /**
            ...
            \errors
                none
        **/
        UnicodeString16() IPL_NOEXCEPT;

        UnicodeString16(const ipl::unicode::String &other) IPL_NOEXCEPT;
        /**
            ...
            \errorindicator
                hasError()
        **/
        explicit UnicodeString16(char const * string, Encoding enc, uint32_t strlength=0, bool terminateAtZero=false, uint32_t* num_bytes_read=NULL) IPL_NOEXCEPT;
        /**
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16(ipl::istream& in, Encoding enc) IPL_NOEXCEPT;

        /**
        * \brief
        *     Construct from an osal::UnicodeString
        **/
        UnicodeString16(const osal::UnicodeString &ucs) IPL_NOEXCEPT;

        // Compatibility hacks, remove ASAP
        UnicodeString16(const osal::BasicPath<char> &path) IPL_NOEXCEPT;
        UnicodeString16(const osal::BasicPath<wchar_t> &path) IPL_NOEXCEPT;
        ...
        **/
        ...
        UnicodeString16(util::DataBuffer<storage> const & db, Encoding enc) IPL_NOEXCEPT
        {
            if (db.size() > 0)
            {
        ...
        **/
        UnicodeString16(uint32_t num_repeat, UnicodeChar const & cp) IPL_NOEXCEPT;
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        explicit UnicodeString16(uint32_t num) IPL_NOEXCEPT {appendNum(num);}
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        explicit UnicodeString16(int32_t num) IPL_NOEXCEPT {appendNum(num);}
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        explicit UnicodeString16(uint64_t num) IPL_NOEXCEPT {appendNum(num);}
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        explicit UnicodeString16(int64_t num) IPL_NOEXCEPT {appendNum(num);}
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        explicit UnicodeString16(double num) IPL_NOEXCEPT {appendNum(num);}
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16(UnicodeString16 const & s) IPL_NOEXCEPT;
        /**
            \brief Copy constructor
            \errors
                ipl::CommonError with ID OUT_OF_MEMORY
            \errorindicator
                hasError()
        **/
        UnicodeString16(UnicodeString8 const & s) IPL_NOEXCEPT;
        /**
            \brief Destructor
            \errors
                none
        **/
        virtual ~UnicodeString16() IPL_NOEXCEPT;
        /**
        ...
        **/
        ...
        /**
                ...
                \errorindicator
                    hasError()
        **/
        iterator& insert(iterator& position, UnicodeString16 const& str) IPL_NOEXCEPT;
        iterator &insert(iterator &position, const UnicodeString8 &str) IPL_NOEXCEPT {
            return insert(position, UnicodeString16(str));
        }
        /**
        ...
        **/
        ...
        \errorindicator
            hasError()
        **/
        iterator insert(const iterator& position, UnicodeString16 const& str) IPL_NOEXCEPT;
        iterator insert(const iterator &position, const UnicodeString8 &str) IPL_NOEXCEPT {
            return insert(position, UnicodeString16(str));
        }
        /**
        \brief erases parts of a string
        ...
        **/
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& append(UnicodeChar codepoint) IPL_NOEXCEPT;
        /**
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& append(const UnicodeString16& str) IPL_NOEXCEPT {insert(end(), str); return *this;}
        UnicodeString16 &append(const UnicodeString8 &str) IPL_NOEXCEPT { insert(end(), str); return *this; }
        ...
        **/
        ...
        util::UnicodeString16 operator+(const UnicodeString16& us) const IPL_NOEXCEPT;
        UnicodeString16 operator + (const UnicodeString8 &other) const IPL_NOEXCEPT {
            return operator + (UnicodeString16(other));
        }
        /**
            ...
            \errorindicator
                hasError()
        **/
        inline util::UnicodeString16& operator+=(const UnicodeString16& us) IPL_NOEXCEPT {return append(us);}
        UnicodeString16 &operator += (const UnicodeString8 &other) IPL_NOEXCEPT {
            return append(other);
        }
        /**
        ...
        **/
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& operator=(UnicodeString8 const& us) IPL_NOEXCEPT;
        /**
            \brief assignment operator
            \errors
                ipl::CommonError with ID OUT_OF_MEMORY
            \errorindicator
                hasError()
        **/
        UnicodeString16& operator=(UnicodeString16 const& us) IPL_NOEXCEPT;

        UnicodeString16 &operator = (const ipl::unicode::String &other) IPL_NOEXCEPT;
...
// #endif
        int32_t compare(UnicodeString16 const & str) const IPL_NOEXCEPT {return util::DataBuffer<STRING_LOCAL_BUFFER_SIZE>::compare(str);}
        int32_t compare(const UnicodeString8 &other) const IPL_NOEXCEPT {
            return util::DataBuffer<STRING_LOCAL_BUFFER_SIZE>::compare(UnicodeString16(other));
        }
// #ifdef __clang__
...
// #endif
        ...
        **/
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        iterator findOccurrenceOf(UnicodeString16 const& str) const IPL_NOEXCEPT;
        iterator findOccurrenceOf(const UnicodeString8 &str) const IPL_NOEXCEPT {
            return findOccurrenceOf(UnicodeString16(str));
        }
        /**
            \brief search the position of a substring
            ...
            \errorindicator
                hasError()
        **/
        iterator findLastOccurrenceOf(UnicodeString16 const& str) const IPL_NOEXCEPT;
        iterator findLastOccurrenceOf(const UnicodeString8 &str) const IPL_NOEXCEPT {
            return findLastOccurrenceOf(UnicodeString16(str));
        }
        /**
        ...
        **/
        ...
        /**
            ...
            \errorindicator
                hasError()
        **/
        uint32_t countOccurrenceOf(UnicodeString16 const& str) const IPL_NOEXCEPT;
        uint32_t countOccurrenceOf(const UnicodeString8 &str) const IPL_NOEXCEPT {
            return countOccurrenceOf(UnicodeString16(str));
        }
        /**
        ...
        **/
        UnicodeString16 substring(iterator const& from, iterator const& to) const IPL_NOEXCEPT;
        /**
            ...
            \errorindicator
                errorindicator of returned string
        **/
        UnicodeString16 argument(UnicodeString16 const& arg) IPL_NOEXCEPT;
        UnicodeString16 argument(const UnicodeString8 &arg) IPL_NOEXCEPT {
            return argument(UnicodeString16(arg));
        }
        /**
        ...
        **/
        uint32_t split(UnicodeChar token, UnicodeString16** result, uint32_t max_splits, bool keep_empty_strings=false) const IPL_NOEXCEPT;
        /**
            \brief get internal storage format
            \errors
                none
        **/
        static Encoding getInternalFormat() IPL_NOEXCEPT {return UTF16;}
        /**
        ...
        **/
        ...
        /**
            ...
            \return true, if the current string ends with \p str or \p str is empty\n
                    false, otherwise
        **/
        bool endsWith(const util::UnicodeString16& str) const IPL_NOEXCEPT;
        bool endsWith(const UnicodeString8 &str) const IPL_NOEXCEPT {
            return endsWith(UnicodeString16(str));
        }
        /**
            \brief checks if the current string begins with \p str
            \return true, if the current string begins with \p str or \p str is empty\n
                    false, otherwise
        **/
        bool beginsWith(const util::UnicodeString16& str) const IPL_NOEXCEPT;
        bool beginsWith(const UnicodeString8 &str) const IPL_NOEXCEPT {
            return beginsWith(UnicodeString16(str));
        }
        /**
        ...
        **/
        ...
        /**
            \brief checks if the current string contains \p str, if \p str is empty, returns true
            \return true, if current string contains \p str or \p str is empty\n
                    false, otherwise
        **/
        inline bool contains(const util::UnicodeString16& str) const IPL_NOEXCEPT
        {
        ...
        inline bool contains(const UnicodeString8 &str) const IPL_NOEXCEPT
        {
            if (this->size() == 0 && this->operator==(str))
            {
                return true;
        ...
        **/
        void trim() IPL_NOEXCEPT;
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& appendNum(int32_t num) IPL_NOEXCEPT;
        /**
            \brief appends an integer to the string
            \param num the number to be appended
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& appendNum(double num) IPL_NOEXCEPT;
        /**
            \brief appends an integer to the string
            \param num the number to be appended
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& appendNum(uint32_t num) IPL_NOEXCEPT;
        /**
            \brief appends an integer to the string
            \param num the number to be appended
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& appendNum(int64_t num) IPL_NOEXCEPT;
        /**
            \brief appends an integer to the string
            \param num the number to be appended
            ...
            \errorindicator
                hasError()
        **/
        UnicodeString16& appendNum(uint64_t num) IPL_NOEXCEPT;
    //     /**
    //         \brief converts the string to uppercase
    //
    //         just a convenience function, see UnicodeTransformer for details
    //     **/
    //     UnicodeString16 toUpper() const IPL_NOEXCEPT;
    //     /**
    //         \brief converts the string to lowercase
    //
    //         just a convenience function, see UnicodeTransformer for details
    //         **/
    //     UnicodeString16 toLower() const IPL_NOEXCEPT;

//         operator UCSWrapper<UnicodeString16>() const IPL_NOEXCEPT
//         {
//             return UCSWrapper<UnicodeString16>(*this);
//         }
        ...
        operator ipl::unicode::String () const IPL_NOEXCEPT {
            return ipl::unicode::String(ipl::SharedBuf(retrieveData(), size()), ipl::unicode::UTF16MACHINE);
        }
        ...
        **/
        bool operator<(const UnicodeString16& str) const IPL_NOEXCEPT {
        ...
        bool operator < (const UnicodeString8 &other) const IPL_NOEXCEPT {
            return DataBuffer<STRING_LOCAL_BUFFER_SIZE>::operator < (UnicodeString16(other));
        }
        ...
        **/
        UnicodeString16 replace(UnicodeString16 const& find, UnicodeString16 const& replaceWith) IPL_NOEXCEPT;
        UnicodeString16 replace(const UnicodeString16 &find, const UnicodeString8 &replaceWith) IPL_NOEXCEPT {
            return replace(find, UnicodeString16(replaceWith));
        }
        UnicodeString16 replace(const UnicodeString8 &find, const UnicodeString16 &replaceWith) IPL_NOEXCEPT {
            return replace(UnicodeString16(find), replaceWith);
        }
        UnicodeString16 replace(const UnicodeString8 &find, const UnicodeString8 &replaceWith) IPL_NOEXCEPT {
            return replace(UnicodeString16(find), UnicodeString16(replaceWith));
        }
    ...
    protected:
        ...
        **/
        ...
        /** determine the length of a code point sequence
            ...
            \errorindicator
                return true
        **/
        static bool sequenceLength16(uint8_t const * const lead_sequence, uint8_t& length, int32_t stoplength) IPL_NOEXCEPT;
        /**
        ...
        **/
        ...
        /**
            \brief convert a code point to utf-16
            \param codepoint the coidepoint to convert
            \param buffer the output buffer for the utf-16 coded sequence
            \return the number of code units needed to store the codepoint in utf16
            \errors
                none
            \note Behavior for invalid unicode codepoint is undefined
        **/
        static uint8_t cpToUtf16(UnicodeChar codepoint, uint8_t buffer[4]) IPL_NOEXCEPT;
        /**
            \brief
...
**/
UTIL_EXPORT ipl::ostream& operator<<(ipl::ostream& out, const util::UnicodeString16& us) IPL_NOEXCEPT;
