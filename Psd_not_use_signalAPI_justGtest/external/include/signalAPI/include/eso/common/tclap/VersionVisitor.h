...
class VersionVisitor: public Visitor
{
    private:
         ...
         */
        VersionVisitor(const VersionVisitor& rhs) IPL_NOEXCEPT;
        VersionVisitor& operator=(const VersionVisitor& rhs) IPL_NOEXCEPT;
    ...
    public:
         ...
         */
        VersionVisitor( CmdLineInterface* cmd, CmdLineOutput** out ) IPL_NOEXCEPT 
