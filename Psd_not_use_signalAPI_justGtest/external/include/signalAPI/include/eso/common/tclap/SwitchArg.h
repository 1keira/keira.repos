...
class SwitchArg : public Arg
{
    ...
    public:
         ...
         */
        bool combinedSwitchesMatch(std::string& combined) IPL_NOEXCEPT;

        /**
         * Returns bool, whether or not the switch has been set.
         */
        bool getValue() IPL_NOEXCEPT;
    ...
    private:
         ...
         * a combined string.
         */
        bool lastCombined(std::string& combined) IPL_NOEXCEPT;

        /**
         * Does the common processing of processArg.
         */
        bool commonProcessing() IPL_NOEXCEPT;
};
...
inline bool SwitchArg::getValue() IPL_NOEXCEPT { return _value; }

inline bool SwitchArg::lastCombined(std::string& combinedSwitches ) IPL_NOEXCEPT 
{
...
inline bool SwitchArg::combinedSwitchesMatch(std::string& combinedSwitches ) IPL_NOEXCEPT
{
...
inline bool SwitchArg::commonProcessing() IPL_NOEXCEPT
{
    if ( _xorSet ) {
...
inline bool SwitchArg::processArg(int *i, std::vector<std::string>& args) IPL_NOEXCEPT
{
...
inline void SwitchArg::reset() IPL_NOEXCEPT
{
    Arg::reset();
    _value = _default;  
}
