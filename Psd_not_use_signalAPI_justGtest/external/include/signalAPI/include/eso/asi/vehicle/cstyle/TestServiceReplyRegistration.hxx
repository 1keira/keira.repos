...
*/
#ifndef ASI_VEHICLE_TEST_SERVICEREPLYREGISTRATION_CSTYLE_HXX
#define ASI_VEHICLE_TEST_SERVICEREPLYREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    class TestReply;
    /**
        \brief The service registration instance for the vehicle::TestReply interface.
    */
    class TestServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        TestServiceReplyRegistration (const ::comm::InstanceID& _instID, TestReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        TestServiceReplyRegistration (const ::comm::InstanceID& _instID, TestReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.vehicle.TestReply"};
            return iname;
        }
...
#endif// ASI_VEHICLE_TEST_SERVICEREPLYREGISTRATION_HXX
