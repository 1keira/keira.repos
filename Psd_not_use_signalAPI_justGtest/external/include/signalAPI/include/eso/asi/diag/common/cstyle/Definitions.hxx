...
*/
#ifndef ASI_DIAG_COMMON_DEFINITIONS_CSTYLE_HXX
#define ASI_DIAG_COMMON_DEFINITIONS_CSTYLE_HXX
...
namespace asi { namespace diag { namespace common { namespace cstyle {
    /**
...
#endif  // ASI_DIAG_COMMON_DEFINITIONS_CSTYLE_HXX
