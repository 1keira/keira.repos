...
*/
#ifndef ASI_SID_V2XSTACK_INTV2XSTACK_SERVICEREPLYREGISTRATION_CSTYLE_HXX
#define ASI_SID_V2XSTACK_INTV2XSTACK_SERVICEREPLYREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the v2xstack::IntV2XStackReply interface.
    */
    class IntV2XStackServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        IntV2XStackServiceReplyRegistration (const ::comm::InstanceID& _instID, IntV2XStackReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        IntV2XStackServiceReplyRegistration (const ::comm::InstanceID& _instID, IntV2XStackReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.sid.v2xstack.IntV2XStackReply"};
            return iname;
        }
...
#endif// ASI_SID_V2XSTACK_INTV2XSTACK_SERVICEREPLYREGISTRATION_HXX
