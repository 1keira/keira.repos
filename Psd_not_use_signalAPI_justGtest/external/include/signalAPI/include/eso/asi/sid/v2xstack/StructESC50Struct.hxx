...
*/
#ifndef ASI_SID_V2XSTACK_ESC50STRUCT_HXX
#define ASI_SID_V2XSTACK_ESC50STRUCT_HXX
    ...
    */
    struct PROXY_EXPORT ESC50Struct
    {
        ...
        private:
            ...
            friend struct std::_Default_allocator_traits< std::allocator<asi::sid::v2xstack::ESC50Struct> >;
    ...
    /** \brief factory for v2xstack::ESC50Struct. */
...
#endif// ASI_SID_V2XSTACK_ESC50STRUCT_HXX
