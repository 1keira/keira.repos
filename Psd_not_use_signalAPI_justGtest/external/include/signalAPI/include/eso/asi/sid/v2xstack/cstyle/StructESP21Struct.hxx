...
*/
#ifndef ASI_SID_V2XSTACK_ESP21STRUCT_CSTYLE_HXX
#define ASI_SID_V2XSTACK_ESP21STRUCT_CSTYLE_HXX
...
bool serialize (util::serializer::IStructuredSerializer &ser, const asi::sid::v2xstack::cstyle::ESP21Struct& val);
bool deserialize (util::serializer::IStructuredPullDeserializer &s, asi::sid::v2xstack::cstyle::ESP21Struct &val);
}
}
    ...
    */
    struct PROXY_EXPORT ESP21Struct
    {
        public:
            ...
            , m_ASR_Tastung_passiv_Raw()
            , m_ESP_Tastung_passiv_Raw()
            , m_ESP_Systemstatus_Raw()
            ...
            bool operator==(const ESP21Struct& rhs) const {
                ...
                if (m_ESP_v_Signal_SignalState != rhs.m_ESP_v_Signal_SignalState)
                    equal = false;
                if (m_ASR_Tastung_passiv_Raw != rhs.m_ASR_Tastung_passiv_Raw)
                    equal = false;
                if (m_ESP_Tastung_passiv_Raw != rhs.m_ESP_Tastung_passiv_Raw)
                    equal = false;
                if (m_ESP_Systemstatus_Raw != rhs.m_ESP_Systemstatus_Raw)
                    equal = false;
                ...
                if (m_ASR_Anf_Raw != rhs.m_ASR_Anf_Raw)
                    equal = false;
                if (m_EDS_Eingriff_Raw != rhs.m_EDS_Eingriff_Raw)
                    equal = false;
            ...
            ESP21Struct& operator = (const ESP21Struct& src) {
                ...
                m_ASR_Tastung_passiv_Raw = src.m_ASR_Tastung_passiv_Raw;
                m_ESP_Tastung_passiv_Raw = src.m_ESP_Tastung_passiv_Raw;
                m_ESP_Systemstatus_Raw = src.m_ESP_Systemstatus_Raw;
                ...
                m_EDS_Eingriff_Raw = src.m_EDS_Eingriff_Raw;
                ...
                void setASR_Tastung_passiv_Raw(const bool _value) {
                    m_ASR_Tastung_passiv_Raw = _value;
                }
                bool getASR_Tastung_passiv_Raw() const {
                    return m_ASR_Tastung_passiv_Raw;
                }
                void setESP_Tastung_passiv_Raw(const bool _value) {
                    m_ESP_Tastung_passiv_Raw = _value;
                }
                bool getESP_Tastung_passiv_Raw() const {
                    return m_ESP_Tastung_passiv_Raw;
                }
                void setESP_Systemstatus_Raw(const bool _value) {
                    m_ESP_Systemstatus_Raw = _value;
                }
                bool getESP_Systemstatus_Raw() const {
                    return m_ESP_Systemstatus_Raw;
                }
                ...
                void setEDS_Eingriff_Raw(const bool _value) {
                    m_EDS_Eingriff_Raw = _value;
                }
                bool getEDS_Eingriff_Raw() const {
                    return m_EDS_Eingriff_Raw;
                }
        ...
        bool m_ASR_Tastung_passiv_Raw;
        bool m_ESP_Tastung_passiv_Raw;
        bool m_ESP_Systemstatus_Raw;
        bool m_ESP_QBit_v_Signal_Raw;
        bool m_ABS_Bremsung_Raw;
        bool m_ASR_Anf_Raw;
        bool m_EDS_Eingriff_Raw;
        bool m_ESP_Eingriff_Raw;
        uint64_t m_PduState;
    private:
        friend bool util::serializer::serialize (util::serializer::IStructuredSerializer &s, const asi::sid::v2xstack::cstyle::ESP21Struct& val);
        friend bool util::serializer::deserialize (util::serializer::IStructuredPullDeserializer &s, asi::sid::v2xstack::cstyle::ESP21Struct &val);
    };
...
#endif// ASI_SID_V2XSTACK_ESP21STRUCT_CSTYLE_HXX
