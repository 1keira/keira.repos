...
*/
#ifndef ASI_SID_V2XSTACK_INTV2XSTACK_SERVICEREGISTRATION_CSTYLE_HXX
#define ASI_SID_V2XSTACK_INTV2XSTACK_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the v2xstack::IntV2XStack interface.
    */
    class IntV2XStackServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        IntV2XStackServiceRegistration (const ::comm::InstanceID& _instID, IntV2XStackS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        IntV2XStackServiceRegistration (const ::comm::InstanceID& _instID, IntV2XStackS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        IntV2XStackServiceRegistration (const ::comm::InstanceID& _instID, IntV2XStackS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        IntV2XStackServiceRegistration (const ::comm::InstanceID& _instID, IntV2XStackS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        IntV2XStackServiceRegistration() {}
...
#endif// ASI_SID_V2XSTACK_INTV2XSTACK_SERVICEREGISTRATION_HXX
