...
*/
#ifndef ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NadMessagingServicesReply interface.
    */
    ...
    public:
        ...
        */
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.NadMessagingServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_NADMESSAGINGSERVICES_SERVICEREPLYREGISTRATION_HXX
