...
*/
#ifndef ASI_CONNECTIVITY_AL_HANDSFREESERVICESS_HXX
#define ASI_CONNECTIVITY_AL_HANDSFREESERVICESS_HXX
...
#include <asi/connectivity/al/HandsfreeServicesServiceRegistration.hxx>
#include <asi/connectivity/al/StructHfpDeviceInformation.hxx>

#include <asi/connectivity/al/Definitions.hxx>

#include <asi/connectivity/al/HandsfreeServicesProxyReply.hxx>
...
namespace al
{
    ...
    /**
    \brief  The al::HandsfreeServices interface on tthe service side.
    \details
            A service instance needs to implement this interface.
    **/
    class HandsfreeServicesS
    {
    public:
        HandsfreeServicesS () {}
    // List of request methods
        ...
        **/
        virtual void enableUpdates(
            const bool enable
            ,HandsfreeServicesProxyReply& reply
        ) = 0;
        /**
            getHfpPhoneInformation Method ID: 1
        **/
        virtual void getHfpPhoneInformation(
        ...
        **/
        virtual void setVoiceRecognition(
            const bool onoff
            ,HandsfreeServicesProxyReply& reply
        ) = 0;
        ...
        */
        bool registerSelf(uint32_t instance_no, const comm::ActiveObjectFactoryPtr& factory, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                HandsfreeServicesServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_HANDSFREESERVICES_REQUEST), instance_no), static_cast<HandsfreeServicesS*>(this), l, factory );
        ...
        */
        bool registerSelf(uint32_t instance_no, comm::LifecycleListener* l=nullptr)
        {
            ...
            m_registration =
                HandsfreeServicesServiceRegistration(comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_HANDSFREESERVICES_REQUEST), instance_no), static_cast<HandsfreeServicesS*>(this), l );
            if (!m_registration.valid()) {
                comm::error::fatal( "can't create ServiceRegistration, OOM ", COMM_HERE);
                return true;
            }
        ...
        */
        bool unregisterSelf()
        {
            ...
            m_registration = HandsfreeServicesServiceRegistration();
            return false;
        }
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            HandsfreeServicesServiceRegistration tmp{m_registration};
        ...
        // call ids
        void
        enableUpdatesCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<HandsfreeServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
            comm::OpaqueMethodID mid= 0;
            ce.assign(inst, mid);
        }
        void
        getHfpPhoneInformationCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<HandsfreeServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        getPhoneStatusCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<HandsfreeServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        setHandsfreeModeCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<HandsfreeServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        setAudioPolicyCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<HandsfreeServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
        ...
        void
        setVoiceRecognitionCallID( comm::CallEvent::CallID& ce )
        {
            void* inst=static_cast<HandsfreeServicesS*>(this);
            // Don't ever rely on these values outside of a CallID
    ...
    protected:
        HandsfreeServicesServiceRegistration m_registration;
    };

} //namespace asi
} //namespace connectivity
} //namespace al
#endif// ASI_CONNECTIVITY_AL_HANDSFREESERVICESS_HXX
