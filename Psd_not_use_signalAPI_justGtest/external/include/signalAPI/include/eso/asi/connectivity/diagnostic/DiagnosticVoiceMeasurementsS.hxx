...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTSS_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTSS_HXX
...
#include <asi/connectivity/diagnostic/DiagnosticVoiceMeasurementsServiceRegistration.hxx>
#include <asi/connectivity/diagnostic/StructEcallOperationStatus.hxx>

#include <asi/connectivity/diagnostic/Definitions.hxx>

#include <asi/connectivity/diagnostic/DiagnosticVoiceMeasurementsProxyReply.hxx>
#include <asi/connectivity/diagnostic/DiagnosticVoiceMeasurementsReplyS.hxx>
...
namespace diagnostic
{
    ...
    /**
    \brief  The diagnostic::DiagnosticVoiceMeasurements interface on tthe service side.
    \details
    ...
    // List of request methods
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            DiagnosticVoiceMeasurementsServiceRegistration tmp{m_registration};
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTSS_HXX
