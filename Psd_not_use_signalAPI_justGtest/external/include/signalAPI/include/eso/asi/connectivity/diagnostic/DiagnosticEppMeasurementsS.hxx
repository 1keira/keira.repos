...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICEPPMEASUREMENTSS_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICEPPMEASUREMENTSS_HXX
...
#include <asi/connectivity/diagnostic/DiagnosticEppMeasurementsServiceRegistration.hxx>
...
namespace diagnostic
{
    ...
    /**
    \brief  The diagnostic::DiagnosticEppMeasurements interface on tthe service side.
    \details
    ...
    // List of request methods
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            DiagnosticEppMeasurementsServiceRegistration tmp{m_registration};
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICEPPMEASUREMENTSS_HXX
