...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTSC_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTSC_HXX
...
namespace diagnostic
{
    ...
    /**
    \brief The diagnostic::DiagnosticViMeasurements interface on the client side.
    \details
            A proxy implements this interface.
    **/
    class DiagnosticViMeasurementsC
    {
    public:
        ...
        **/
        virtual bool getHostnameRegisterPairing(
        ...
        **/
        ...
        DiagnosticViMeasurementsC()  {}
        virtual ~DiagnosticViMeasurementsC() {}
    protected:
        friend class DiagnosticViMeasurementsProxy;
    };

}//namespace asi
}//namespace connectivity
}//namespace diagnostic
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVIMEASUREMENTSC_HXX
