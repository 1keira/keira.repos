...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIROUTINE_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIROUTINE_SERVICEREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::ViRoutine interface.
    */
    class ViRoutineServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViRoutineServiceRegistration (const ::comm::InstanceID& _instID, ViRoutineS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViRoutineServiceRegistration (const ::comm::InstanceID& _instID, ViRoutineS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ViRoutineServiceRegistration (const ::comm::InstanceID& _instID, ViRoutineS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        ViRoutineServiceRegistration (const ::comm::InstanceID& _instID, ViRoutineS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIROUTINE_SERVICEREGISTRATION_HXX
