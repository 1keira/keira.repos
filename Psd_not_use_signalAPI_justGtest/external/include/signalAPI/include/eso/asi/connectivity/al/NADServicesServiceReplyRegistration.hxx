...
*/
#ifndef ASI_CONNECTIVITY_AL_NADSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NADServicesReply interface.
    */
    class NADServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NADServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NADServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NADServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, NADServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.NADServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_NADSERVICES_SERVICEREPLYREGISTRATION_HXX
