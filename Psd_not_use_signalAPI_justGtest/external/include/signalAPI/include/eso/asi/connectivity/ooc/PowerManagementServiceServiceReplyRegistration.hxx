...
*/
#ifndef ASI_CONNECTIVITY_OOC_POWERMANAGEMENTSERVICE_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_OOC_POWERMANAGEMENTSERVICE_SERVICEREPLYREGISTRATION_HXX
...
namespace ooc
{
    ...
    /**
        \brief The service registration instance for the ooc::PowerManagementServiceReply interface.
    */
    class PowerManagementServiceServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        PowerManagementServiceServiceReplyRegistration (const ::comm::InstanceID& _instID, PowerManagementServiceReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        PowerManagementServiceServiceReplyRegistration (const ::comm::InstanceID& _instID, PowerManagementServiceReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.ooc.PowerManagementServiceReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_OOC_POWERMANAGEMENTSERVICE_SERVICEREPLYREGISTRATION_HXX
