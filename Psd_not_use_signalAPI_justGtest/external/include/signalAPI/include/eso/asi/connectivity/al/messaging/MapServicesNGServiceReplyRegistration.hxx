...
*/
#ifndef ASI_CONNECTIVITY_AL_MESSAGING_MAPSERVICESNG_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_MESSAGING_MAPSERVICESNG_SERVICEREPLYREGISTRATION_HXX
...
namespace messaging
{
    ...
    /**
        \brief The service registration instance for the messaging::MapServicesNGReply interface.
    */
    class MapServicesNGServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        MapServicesNGServiceReplyRegistration (const ::comm::InstanceID& _instID, MapServicesNGReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        MapServicesNGServiceReplyRegistration (const ::comm::InstanceID& _instID, MapServicesNGReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.messaging.MapServicesNGReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_MESSAGING_MAPSERVICESNG_SERVICEREPLYREGISTRATION_HXX
