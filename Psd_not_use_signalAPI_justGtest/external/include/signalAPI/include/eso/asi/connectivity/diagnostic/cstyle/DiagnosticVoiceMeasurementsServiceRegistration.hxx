...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTS_SERVICEREGISTRATION_CSTYLE_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTS_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticVoiceMeasurements interface.
    */
    class DiagnosticVoiceMeasurementsServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticVoiceMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticVoiceMeasurementsS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticVoiceMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticVoiceMeasurementsS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        DiagnosticVoiceMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticVoiceMeasurementsS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        DiagnosticVoiceMeasurementsServiceRegistration (const ::comm::InstanceID& _instID, DiagnosticVoiceMeasurementsS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        DiagnosticVoiceMeasurementsServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICVOICEMEASUREMENTS_SERVICEREGISTRATION_HXX
