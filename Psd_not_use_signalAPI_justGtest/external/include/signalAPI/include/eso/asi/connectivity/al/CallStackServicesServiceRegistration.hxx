...
*/
#ifndef ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::CallStackServices interface.
    */
    class CallStackServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        CallStackServicesServiceRegistration (const ::comm::InstanceID& _instID, CallStackServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        CallStackServicesServiceRegistration (const ::comm::InstanceID& _instID, CallStackServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        CallStackServicesServiceRegistration (const ::comm::InstanceID& _instID, CallStackServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        CallStackServicesServiceRegistration (const ::comm::InstanceID& _instID, CallStackServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        CallStackServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_CALLSTACKSERVICES_SERVICEREGISTRATION_HXX
