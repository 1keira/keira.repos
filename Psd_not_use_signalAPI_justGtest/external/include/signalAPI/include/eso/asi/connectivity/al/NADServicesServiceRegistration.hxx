...
*/
#ifndef ASI_CONNECTIVITY_AL_NADSERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_NADSERVICES_SERVICEREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::NADServices interface.
    */
    class NADServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NADServicesServiceRegistration (const ::comm::InstanceID& _instID, NADServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NADServicesServiceRegistration (const ::comm::InstanceID& _instID, NADServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        NADServicesServiceRegistration (const ::comm::InstanceID& _instID, NADServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        NADServicesServiceRegistration (const ::comm::InstanceID& _instID, NADServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        NADServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_NADSERVICES_SERVICEREGISTRATION_HXX
