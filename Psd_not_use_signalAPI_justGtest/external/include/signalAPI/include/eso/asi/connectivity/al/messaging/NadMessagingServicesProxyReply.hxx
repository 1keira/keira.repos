...
*/
#ifndef ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_PROXYREPLY_HXX
#define ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_PROXYREPLY_HXX
...
namespace messaging
{
    ...
    public:
        ...
        : Proxy(comm::Proxy::IdentityArgs(
            comm::InstanceID (comm::InterfaceID(BINARY_UUID_ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_REPLY), inst_cnt)
    ...
    private:
        static const comm::InterfaceKey& getRIKey() {
            static comm::InterfaceKey rikey(0x00020000, 0x0001, 0x6000, 0x0000, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00);
            return rikey;
        }
...
#endif// ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_PROXYREPLY_HXX
