...
*/
#ifndef ASI_CONNECTIVITY_AL_BLUETOOTHSERVICES_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_BLUETOOTHSERVICES_SERVICEREPLYREGISTRATION_HXX
...
namespace al
{
    ...
    /**
        \brief The service registration instance for the al::BluetoothServicesReply interface.
    */
    class BluetoothServicesServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        BluetoothServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, BluetoothServicesReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        BluetoothServicesServiceReplyRegistration (const ::comm::InstanceID& _instID, BluetoothServicesReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.al.BluetoothServicesReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_AL_BLUETOOTHSERVICES_SERVICEREPLYREGISTRATION_HXX
