...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICCCMMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICCCMMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::DiagnosticCcmMeasurementsReply interface.
    */
    class DiagnosticCcmMeasurementsServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        DiagnosticCcmMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticCcmMeasurementsReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        DiagnosticCcmMeasurementsServiceReplyRegistration (const ::comm::InstanceID& _instID, DiagnosticCcmMeasurementsReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"asi.connectivity.diagnostic.DiagnosticCcmMeasurementsReply"};
            return iname;
        }
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_DIAGNOSTICCCMMEASUREMENTS_SERVICEREPLYREGISTRATION_HXX
