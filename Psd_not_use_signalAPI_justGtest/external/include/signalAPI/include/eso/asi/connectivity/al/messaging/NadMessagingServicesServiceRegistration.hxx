...
*/
#ifndef ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_SERVICEREGISTRATION_HXX
...
namespace messaging
{
    ...
    /**
        \brief The service registration instance for the messaging::NadMessagingServices interface.
    */
    class NadMessagingServicesServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        NadMessagingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadMessagingServicesS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        NadMessagingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadMessagingServicesS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        NadMessagingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadMessagingServicesS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        NadMessagingServicesServiceRegistration (const ::comm::InstanceID& _instID, NadMessagingServicesS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        NadMessagingServicesServiceRegistration() {}
...
#endif// ASI_CONNECTIVITY_AL_MESSAGING_NADMESSAGINGSERVICES_SERVICEREGISTRATION_HXX
