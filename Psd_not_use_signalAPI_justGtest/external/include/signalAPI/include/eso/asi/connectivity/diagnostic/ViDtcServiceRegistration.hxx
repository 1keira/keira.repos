...
*/
#ifndef ASI_CONNECTIVITY_DIAGNOSTIC_VIDTC_SERVICEREGISTRATION_HXX
#define ASI_CONNECTIVITY_DIAGNOSTIC_VIDTC_SERVICEREGISTRATION_HXX
...
namespace diagnostic
{
    ...
    /**
        \brief The service registration instance for the diagnostic::ViDtc interface.
    */
    class ViDtcServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ViDtcServiceRegistration (const ::comm::InstanceID& _instID, ViDtcS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ViDtcServiceRegistration (const ::comm::InstanceID& _instID, ViDtcS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ViDtcServiceRegistration (const ::comm::InstanceID& _instID, ViDtcS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        ViDtcServiceRegistration (const ::comm::InstanceID& _instID, ViDtcS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
...
#endif// ASI_CONNECTIVITY_DIAGNOSTIC_VIDTC_SERVICEREGISTRATION_HXX
