...
*/
#ifndef SERVMNGT_ISERVICEMANAGER_SERVICEREPLYREGISTRATION_HXX
#define SERVMNGT_ISERVICEMANAGER_SERVICEREPLYREGISTRATION_HXX
...
namespace servmngt
{
    ...
    /**
        \brief The service registration instance for the servmngt::IServiceManagerReply interface.
    */
    class IServiceManagerServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        IServiceManagerServiceReplyRegistration (const ::comm::InstanceID& _instID, IServiceManagerReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        IServiceManagerServiceReplyRegistration (const ::comm::InstanceID& _instID, IServiceManagerReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"servmngt.IServiceManagerReply"};
            return iname;
        }
...
#endif// SERVMNGT_ISERVICEMANAGER_SERVICEREPLYREGISTRATION_HXX
