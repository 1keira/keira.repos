...
*/
#ifndef SERVMNGT_ISERVICEMANAGER_SERVICEREGISTRATION_HXX
#define SERVMNGT_ISERVICEMANAGER_SERVICEREGISTRATION_HXX
...
namespace servmngt
{
    ...
    /**
        \brief The service registration instance for the servmngt::IServiceManager interface.
    */
    class IServiceManagerServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        IServiceManagerServiceRegistration (const ::comm::InstanceID& _instID, IServiceManagerS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        IServiceManagerServiceRegistration (const ::comm::InstanceID& _instID, IServiceManagerS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        IServiceManagerServiceRegistration (const ::comm::InstanceID& _instID, IServiceManagerS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        IServiceManagerServiceRegistration (const ::comm::InstanceID& _instID, IServiceManagerS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        IServiceManagerServiceRegistration() {}
...
#endif// SERVMNGT_ISERVICEMANAGER_SERVICEREGISTRATION_HXX
