...
*/
#ifndef SERVMNGT_EXTENSIONS_SERVICEMANAGEREVENTS_SERVICEREGISTRATION_CSTYLE_HXX
#define SERVMNGT_EXTENSIONS_SERVICEMANAGEREVENTS_SERVICEREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    /**
        \brief The service registration instance for the extensions::ServiceManagerEvents interface.
    */
    class ServiceManagerEventsServiceRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        ServiceManagerEventsServiceRegistration (const ::comm::InstanceID& _instID, ServiceManagerEventsS& svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        ServiceManagerEventsServiceRegistration (const ::comm::InstanceID& _instID, ServiceManagerEventsS& svc, ::comm::LifecycleListener& l)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,&svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ServiceManagerEventsServiceRegistration (const ::comm::InstanceID& _instID, ServiceManagerEventsS* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        \param  p a factory for ActiveObjects. This allows to control the threads that call into the service.
        */
        ServiceManagerEventsServiceRegistration (const ::comm::InstanceID& _instID, ServiceManagerEventsS* svc, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getIKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        */
        ...
        // default ctor
        ServiceManagerEventsServiceRegistration() {}
...
#endif// SERVMNGT_EXTENSIONS_SERVICEMANAGEREVENTS_SERVICEREGISTRATION_HXX
