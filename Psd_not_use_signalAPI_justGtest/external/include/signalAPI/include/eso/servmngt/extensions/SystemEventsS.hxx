...
*/
#ifndef SERVMNGT_EXTENSIONS_SYSTEMEVENTSS_HXX
#define SERVMNGT_EXTENSIONS_SYSTEMEVENTSS_HXX
...
#include <servmngt/extensions/SystemEventsServiceRegistration.hxx>

#include <servmngt/extensions/Definitions.hxx>

#include <servmngt/extensions/SystemEventsProxyReply.hxx>
#include <servmngt/extensions/SystemEventsReplyS.hxx>
...
namespace extensions
{
    ...
    /**
    \brief  The extensions::SystemEvents interface on tthe service side.
    \details
    ...
    // List of request methods
        ...
        */
        bool unregisterSelf(comm::ServiceReleasedFct callback, void* ctx) // NOSONAR - must not be changed because of API compatibility
        {
            ...
            SystemEventsServiceRegistration tmp{m_registration};
...
#endif// SERVMNGT_EXTENSIONS_SYSTEMEVENTSS_HXX
