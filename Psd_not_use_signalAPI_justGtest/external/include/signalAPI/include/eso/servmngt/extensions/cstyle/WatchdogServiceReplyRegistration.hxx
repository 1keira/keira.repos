...
*/
#ifndef SERVMNGT_EXTENSIONS_WATCHDOG_SERVICEREPLYREGISTRATION_CSTYLE_HXX
#define SERVMNGT_EXTENSIONS_WATCHDOG_SERVICEREPLYREGISTRATION_CSTYLE_HXX
...
namespace cstyle
{
    ...
    class WatchdogReply;
    /**
        \brief The service registration instance for the extensions::WatchdogReply interface.
    */
    class WatchdogServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        WatchdogServiceReplyRegistration (const ::comm::InstanceID& _instID, WatchdogReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        WatchdogServiceReplyRegistration (const ::comm::InstanceID& _instID, WatchdogReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"servmngt.extensions.WatchdogReply"};
            return iname;
        }
...
#endif// SERVMNGT_EXTENSIONS_WATCHDOG_SERVICEREPLYREGISTRATION_HXX
