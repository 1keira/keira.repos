...
*/
#ifndef PERSISTENCE_IPERSISTENCEB_SERVICEREPLYREGISTRATION_HXX
#define PERSISTENCE_IPERSISTENCEB_SERVICEREPLYREGISTRATION_HXX
...
namespace persistence
{
    ...
    /**
        \brief The service registration instance for the persistence::IPersistenceBReply interface.
    */
    class IPersistenceBServiceReplyRegistration  : public comm::ServiceRegistration
    {
    public:
        /**
        ...
        */
        IPersistenceBServiceReplyRegistration (const ::comm::InstanceID& _instID, IPersistenceBReply* svc, ::comm::LifecycleListener* l=nullptr)
        ...
        */
        IPersistenceBServiceReplyRegistration (const ::comm::InstanceID& _instID, IPersistenceBReply* svc, ::comm::LifecycleListener* l, const comm::ActiveObjectFactoryPtr& p)
        :ServiceRegistration(comm::IdentityArgs(_instID, getInterfaceKey(), getIName())
            ,svc
            ,comm::CIPtrStyle
            ,serviceInitFactory
        ...
        static const std::string& getIName() {
            static const std::string iname{"persistence.IPersistenceBReply"};
            return iname;
        }
...
#endif// PERSISTENCE_IPERSISTENCEB_SERVICEREPLYREGISTRATION_HXX
