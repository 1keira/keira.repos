...
*/
#ifndef PERSISTENCE_DEFINITIONS_CSTYLE_HXX
#define PERSISTENCE_DEFINITIONS_CSTYLE_HXX
...
namespace persistence { namespace cstyle {
    /**
...
// Streaming operators for all enum arrays
        ...
        inline bool serialize(IStructuredSerializer& s, const persistence::cstyle::RequestStatus  e)
        {
        ...
        inline bool deserialize(IStructuredPullDeserializer& s, persistence::cstyle::RequestStatus & e)
        {
            int32_t value;
            ...
            if (!error) {
                ...
                e = (persistence::cstyle::RequestStatus) value;
            }
            return error;
        }
...
#endif  // PERSISTENCE_DEFINITIONS_CSTYLE_HXX
